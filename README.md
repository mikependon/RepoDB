...
RepoDb.Core.UnitTest	      | [![Build status](https://ci.appveyor.com/api/projects/status/78nch60yyoj6wiok?svg=true)](https://ci.appveyor.com/project/mikependon/repodb-yf1cx) | https://img.shields.io/appveyor/tests/mikependon/repodb-yf1cx |
RepoDb.Core.IntegrationTest   | [![Build status](https://ci.appveyor.com/api/projects/status/3fsp38vaqchmec7y?svg=true)](https://ci.appveyor.com/project/mikependon/repodb-qksas) | https://img.shields.io/appveyor/tests/mikependon/repodb-qksas |
...
RepoDb.SqLite.UnitTest        | [![Build status](https://ci.appveyor.com/api/projects/status/ihfbuacunufan6vx?svg=true)](https://ci.appveyor.com/project/mikependon/repodb-mhpo4) | https://img.shields.io/appveyor/tests/mikependon/repodb-mhpo4 |
RepoDb.SqLite.IntegrationTest | [![Build status](https://ci.appveyor.com/api/projects/status/r98i8f440hjs5q68?svg=true)](https://ci.appveyor.com/project/mikependon/repodb-eg27p) | https://img.shields.io/appveyor/tests/mikependon/repodb-eg27p |
