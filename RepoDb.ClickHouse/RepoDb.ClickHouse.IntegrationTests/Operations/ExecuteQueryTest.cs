...
namespace RepoDb.ClickHouse.IntegrationTests.Operations
{
    ...
    public class ExecuteQueryTest
    {
        ...
        [TestMethod]
        public void TestClickHouseConnectionExecuteQuery()
        {
            // Setup
        ...
        [TestMethod]
        public void TestClickHouseConnectionExecuteQueryWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestClickHouseConnectionExecuteQueryAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestClickHouseConnectionExecuteQueryAsyncWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
