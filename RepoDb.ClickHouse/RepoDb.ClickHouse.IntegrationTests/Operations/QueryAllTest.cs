...
namespace RepoDb.ClickHouse.IntegrationTests.Operations
{
    ...
    public class QueryAllTest
    {
        ...
        [TestMethod]
        public void TestClickHouseConnectionQueryAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestClickHouseConnectionQueryAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestClickHouseConnectionQueryAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestClickHouseConnectionQueryAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
