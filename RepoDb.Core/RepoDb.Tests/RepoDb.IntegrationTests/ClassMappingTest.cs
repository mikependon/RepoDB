...
namespace RepoDb.IntegrationTests
{
    ...
    public class ClassMappingTest
    {
        ...
        {
            new MappedCompleteTableClassMap();
            new MappedIdentityTableClassMap();
            new MappedCompleteTableForKeyClassMap();
        }
        ...
        private class MappedCompleteTableClassMap : ClassMap<MappedCompleteTable>
        {
            public MappedCompleteTableClassMap()
            {
                Table("[dbo].[COMPLETETABLE]");
                Primary(e => e.SessionIdMapped);
                Property(e => e.SessionIdMapped).Column("SESSIONID");
                Property(e => e.ColumnBigIntMapped).Column("COLUMNBIGINT");
                Property(e => e.ColumnBitMapped).Column("COLUMNBIT");
                Property(e => e.ColumnIntMapped).Column("COLUMNINT");
                Property(e => e.ColumnDateTimeMapped).Column("COLUMNDATETIME");
                Property(e => e.ColumnDateTime2Mapped).Column("COLUMNDATETIME2");
                Property(e => e.ColumnNVarCharMapped).Column("COLUMNNVARCHAR");
            }
        }

        private class MappedIdentityTableClassMap : ClassMap<MappedIdentityTable>
        {
            public MappedIdentityTableClassMap()
            {
                Table("[sc].[IDENTITYTABLE]");
                Primary(e => e.IdMapped);
                Property(e => e.IdMapped).Column("ID");
                Property(e => e.RowGuidMapped).Column("ROWGUID");
                Property(e => e.ColumnBitMapped).Column("COLUMNBIT");
                Property(e => e.ColumnIntMapped).Column("COLUMNINT");
                Property(e => e.ColumnDateTimeMapped).Column("COLUMNDATETIME");
                Property(e => e.ColumnDateTime2Mapped).Column("COLUMNDATETIME2");
                Property(e => e.ColumnFloatMapped).Column("COLUMNFLOAT");
                Property(e => e.ColumnNVarCharMapped).Column("COLUMNNVARCHAR");
            }
        }

        private class MappedCompleteTableForKeyClassMap : ClassMap<MappedCompleteTableForKey>
        {
            public MappedCompleteTableForKeyClassMap()
            {
                Table("[dbo].[COMPLETETABLE]");
                Property(e => e.IdMapped).Column("SESSIONID");
            }
        }
