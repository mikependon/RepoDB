...
namespace RepoDb.IntegrationTests.Types.Dates
{
    ...
    public class BaseRepositoryDatesTest
    {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryDatesCrudAsync2()
        {
            // Setup
            var dateTime = new DateTime(1970, 1, 1, 12, 50, 30, DateTimeKind.Utc);
            var dateTime2 = dateTime.AddMilliseconds(100);
        ...
        [TestMethod]
        public async Task TestBaseRepositoryDatesNullCrudAsync2()
        {
            // Setup
            var entity = new DatesClass
            {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryDatesMappedCrudAsync2()
        {
            // Setup
            var dateTime = new DateTime(1970, 1, 1, 12, 50, 30, DateTimeKind.Utc);
            var dateTime2 = dateTime.AddMilliseconds(100);
        ...
        [TestMethod]
        public async Task TestBaseRepositoryDatesMappedNullCrudAsync2()
        {
            // Setup
            var entity = new DatesMapClass
            {
