...
namespace RepoDb.IntegrationTests.Types.Numbers
{
    ...
    public class BaseRepositoryNumbersTest
    {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryNumbersCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryNumbersNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryNumbersMappedCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
        ...
        [TestMethod]
        public async Task TestBaseRepositoryNumbersMappedNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
