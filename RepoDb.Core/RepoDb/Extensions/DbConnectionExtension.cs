            ...
            where TEntity : DataEntity
        {
            ...
            what?
                ...
                .ForEach(recursiveData =>
                {
                    ...
                    // Get the method
                    var method = typeof(DbConnectionExtension).GetTypeInfo().GetMethod("QueryData", BindingFlags.Static | BindingFlags.NonPublic);
                    ...
                    var foreignProperty = recursiveData.ChildDataType.GetTypeInfo().GetProperty(foreign.AsUnquoted());
