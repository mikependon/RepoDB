...
namespace RepoDb.Db2.IntegrationTests.Operations
{
    ...
    public class MaxAllTest
    {
        ...
        [TestMethod]
        public void TestDb2ConnectionMaxAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestDb2ConnectionMaxAllWithAutomaticConversion()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public void TestDb2ConnectionMaxAllWithHintsThrows()
        {
            // Setup
            ...
            using (var connection = new DB2Connection(Database.ConnectionString))
            {
                ...
                Assert.Throws<NotSupportedException>(() =>
                    connection.MaxAll<CompleteTable>(e => e.ColumnInt, hints: "NOLOCK"));
            }
        }
        ...
        [TestMethod]
        public async Task TestDb2ConnectionMaxAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task TestDb2ConnectionMaxAllAsyncWithAutomaticConversion()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task TestDb2ConnectionMaxAllAsyncWithHintsThrows()
        {
            // Setup
            Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestDb2ConnectionMaxAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task TestDb2ConnectionMaxAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
