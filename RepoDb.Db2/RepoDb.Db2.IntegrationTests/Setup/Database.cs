...
namespace RepoDb.Db2.IntegrationTests.Setup
{
    public static class Database
    {
        ...
        public static void Initialize()
        {
            ...
            // repo root (container-registry.db2.com/database/free, ORACLE_PWD=RepoDB2026),
            ...
            // Db2 has no native GUID type; "SessionId" is stored as RAW(16). Scope the Guid<->byte[]
        ...
        {
            // Db2 has no "CREATE TABLE IF NOT EXISTS"; guard with a PL/SQL block instead.
            var commandText = @"
                BEGIN
