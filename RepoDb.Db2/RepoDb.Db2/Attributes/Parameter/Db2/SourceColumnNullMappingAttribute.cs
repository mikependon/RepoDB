...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="DB2Parameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(DB2Parameter), nameof(DB2Parameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
