...
namespace RepoDb.DbHelpers
{
    ...
    public sealed class Db2DbHelper : IDbHelper
    {
        ...
        /// <summary>
        /// Gets the newly generated identity from the database. Db2 has no session-wide
        ...
        public T GetScopeIdentity<T>(IDbConnection connection,
            IDbTransaction transaction = null) =>
            throw new NotSupportedException("Db2 has no session-wide scope identity. The generated " +
        ...
        /// <summary>
        /// Gets the newly generated identity from the database in an asynchronous way. Db2 has no
