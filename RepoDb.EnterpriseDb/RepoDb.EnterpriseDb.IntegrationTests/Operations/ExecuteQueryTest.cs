...
namespace RepoDb.EnterpriseDb.IntegrationTests.Operations
{
    ...
    public class ExecuteQueryTest
    {
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionExecuteQuery()
        {
            // Setup
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionExecuteQueryWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionExecuteQueryAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionExecuteQueryAsyncWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
