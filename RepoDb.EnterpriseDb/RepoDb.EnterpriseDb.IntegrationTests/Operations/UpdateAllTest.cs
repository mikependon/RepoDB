...
namespace RepoDb.EnterpriseDb.IntegrationTests.Operations
{
    ...
    public class UpdateAllTest
    {
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionUpdateAll()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionUpdateAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionUpdateAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionUpdateAllViaTableNameAsExpandoObjects()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionUpdateAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionUpdateAllAsyncViaTableNameAsExpandoObjects()
        {
            // Setup
            var entities = Database.CreateCompleteTables(10).AsList();
