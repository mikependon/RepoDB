...
{
    /// <summary>
    /// A class used to build a SQL Statement for EnterpriseDB (EDB Postgres Advanced Server).
    /// </summary>
    public sealed class EnterpriseDbStatementBuilder : BaseStatementBuilder
    {
        /// <summary>
        /// Creates a new instance of <see cref="EnterpriseDbStatementBuilder"/> object.
        /// </summary>
        public EnterpriseDbStatementBuilder()
            : this(DbSettingMapper.Get<EDBConnection>(),
                  new EnterpriseDbConvertFieldResolver(),
                  new ClientTypeToAverageableClientTypeResolver())
        { }

        /// <summary>
        /// Creates a new instance of <see cref="EnterpriseDbStatementBuilder"/> class.
        /// </summary>
            ...
            string hints = null)
        {
            ...
            //    var databaseType = (dbType != null) ? new DbTypeToEnterpriseDbStringNameResolver().Resolve(dbType.Value) : null;
        ...
        private string GetDatabaseType(DbField dbField)
        {
            ...
            return dbType.HasValue ?
                new DbTypeToEnterpriseDbStringNameResolver().Resolve(dbType.Value) : null;
        }
