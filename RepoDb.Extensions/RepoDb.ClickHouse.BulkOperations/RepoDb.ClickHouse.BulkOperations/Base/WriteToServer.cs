...
namespace RepoDb
{
    ...
    public static partial class ClickHouseConnectionExtension
    {
        ...
        /// <returns></returns>
        internal static int WriteToServerInternal<TEntity>(ClickHouseConnection connection,
            string tableName,
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        internal static int WriteToServerInternal(ClickHouseConnection connection,
            string tableName,
            DataTable table,
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        internal static async Task<int> WriteToServerAsyncInternal<TEntity>(ClickHouseConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        internal static async Task<int> WriteToServerAsyncInternal(ClickHouseConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            ...
            if (mappings != null)
            {
                ...
                foreach (var mapping in columnMappings)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new ClickHouseBulkCopyColumnMapping(sourceOrdinal, mapping.DestinationColumn));
                }
            }
            else
            {
                foreach (DataColumn column in table.Columns)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new ClickHouseBulkCopyColumnMapping(table.Columns.IndexOf(column), column.ColumnName));
                }
            }
            return bulkCopy;
        }
        ...
        /// <returns></returns>
        /// <exception cref="InvalidTypeException"></exception>
        private static (ClickHouseBulkCopy BulkCopy, IDataReader Reader) CreateBulkCopyForDataReader(ClickHouseConnection connection,
            string tableName,
            IDataReader reader,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings,
            int? bulkCopyTimeout,
            ...
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < columnMappings.Count; i++)
            {
                ...
                bulkCopy.ColumnMappings.Add(new ClickHouseBulkCopyColumnMapping(i, columnMappings[i].DestinationColumn));
            }
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        private static IEnumerable<ClickHouseBulkInsertMapItem> GetDefaultMappingsForDataReader(ClickHouseConnection connection,
            string tableName,
            IDataReader reader,
            DbTransaction transaction,
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < reader.FieldCount; i++)
            {
                ...
                {
                    yield return new ClickHouseBulkInsertMapItem(columnName, dbField.Name);
                }
            }
        }
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static DbCommand CreateTraceCommand(ClickHouseConnection connection,
            string commandText,
