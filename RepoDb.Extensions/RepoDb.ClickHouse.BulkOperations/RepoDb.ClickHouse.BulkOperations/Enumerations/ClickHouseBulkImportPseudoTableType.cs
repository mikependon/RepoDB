...
namespace RepoDb.Enumerations.ClickHouse
{
    ...
    /// operation against ClickHouse.
    /// </summary>
    public enum ClickHouseBulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="ClickHouseConstants.RowCountThresholdForPhysicalTable"/>, otherwise selects
