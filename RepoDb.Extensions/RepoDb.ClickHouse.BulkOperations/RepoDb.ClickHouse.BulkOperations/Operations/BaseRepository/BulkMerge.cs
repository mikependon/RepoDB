...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the ClickHouse bulk-merge
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkMerge<TEntity>(this BaseRepository<TEntity, ClickHouseConnection> repository,
        ...
        /// <returns>The number of affected rows.</returns>
        public static Task<int> BulkMergeAsync<TEntity>(this BaseRepository<TEntity, ClickHouseConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
