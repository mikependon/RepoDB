...
namespace RepoDb
{
    public static partial class ClickHouseConnectionExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this ClickHouseConnection connection,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this ClickHouseConnection connection,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
