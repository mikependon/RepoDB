...
namespace RepoDb
{
    public static partial class ClickHouseConnectionExtension
    {
        ...
        public static int BulkMerge<TEntity>(this ClickHouseConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of affected rows.</returns>
        public static int BulkMerge(this ClickHouseConnection connection,
            DataTable table,
            IEnumerable<Field> qualifiers = null,
        ...
        /// <returns>The number of affected rows.</returns>
        public static Task<int> BulkMergeAsync<TEntity>(this ClickHouseConnection connection,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of affected rows.</returns>
        public static Task<int> BulkMergeAsync(this ClickHouseConnection connection,
            DataTable table,
            IEnumerable<Field> qualifiers = null,
            DataRowState? rowState = null,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
