...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the ClickHouse bulk-insert operation. Each method
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this DbRepository<ClickHouseConnection> repository,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static async Task<int> BulkInsertAsync<TEntity>(this DbRepository<ClickHouseConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
