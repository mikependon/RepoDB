...
namespace RepoDb.IntegrationTests.Setup
{
    ...
    public static class Database
    {
        ...
        {
            using var connection = new DB2Connection(ConnectionStringForSystem);
        ...
        /// Required for <c>LOAD DATA LOCAL INFILE</c> - the mechanism <c>DB2BulkCopy</c> uses under the
        ...
        /// <c>CHAR(36)</c> column that Db2 binds directly to/from <see cref="Guid"/> using its
