...
namespace RepoDb
{
    ...
    public static partial class Db2ConnectionExtension
    {
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        internal static int WriteToServerInternal(DB2Connection connection,
            string tableName,
            DataTable table,
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        internal static async Task<int> WriteToServerAsyncInternal(DB2Connection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<Db2BulkInsertMapItem> mappings = null,
        ...
        private static DB2BulkCopy CreateBulkCopyForDataTable(DB2Connection connection,
            string tableName,
            DataTable table,
            ...
            if (mappings != null)
            {
                ...
                foreach (var mapping in columnMappings)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new DB2BulkCopyColumnMapping(sourceOrdinal, mapping.DestinationColumn));
                }
            }
            else
            {
                ...
                foreach (DataColumn column in table.Columns)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new DB2BulkCopyColumnMapping(table.Columns.IndexOf(column), column.ColumnName));
                }
            }
            return bulkCopy;
        }
        ...
        /// <returns></returns>
        /// <exception cref="InvalidTypeException"></exception>
        private static (DB2BulkCopy BulkCopy, IDataReader Reader) CreateBulkCopyForDataReader(DB2Connection connection,
            string tableName,
            IDataReader reader,
            IEnumerable<Db2BulkInsertMapItem> mappings,
            DB2BulkCopyOptions bulkCopyOptions,
            ...
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < columnMappings.Count; i++)
            {
                ...
                bulkCopy.ColumnMappings.Add(new DB2BulkCopyColumnMapping(i, columnMappings[i].DestinationColumn));
            }
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        private static IEnumerable<Db2BulkInsertMapItem> GetDefaultMappingsForDataReader(DB2Connection connection,
            string tableName,
            IDataReader reader,
            DB2Transaction transaction,
            Field excludeField = null)
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static DbCommand CreateTraceCommand(DB2Connection connection,
            string commandText,
