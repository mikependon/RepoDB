...
{
    /// <summary>
    /// Builds every SQL text used by the Db2 bulk-operations pseudo-table pipeline. This class was
    ...
    /// requires <c>AllowUserVariables=True</c> on the connection string - Db2 defaults this to
    /// <see langword="false"/>.
    /// </summary>
    internal static class Db2Text
    {
        ...
        /// they assign it explicitly themselves. <c>Db2BulkImportPseudoTableType.Physical</c>
            ...
            Field qualifierField = null)
        {
            ...
            var temporaryKeyword = pseudoTableType == Db2BulkImportPseudoTableType.Physical
                ? string.Empty
                : "TEMPORARY ";
        ...
        /// (<c>Db2Execution.GetIdentitySequenceMetadata</c>) is kept for signature compatibility,
        ...
        /// Db2's documented behavior for a batched command.
        /// </remarks>
