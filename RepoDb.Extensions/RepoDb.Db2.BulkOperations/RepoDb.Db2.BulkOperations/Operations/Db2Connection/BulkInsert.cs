...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for Db2, exposed as <see cref="DB2Connection"/>
    ...
    public static partial class Db2ConnectionExtension
    {
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this DB2Connection connection,
            DataTable table,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this DB2Connection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<Db2BulkInsertMapItem> mappings = null,
            DB2BulkCopyOptions bulkCopyOptions = default,
