...
namespace RepoDb.Firebird.BulkOperations.IntegrationTests
{
    ...
    public static class Helper
    {
        static Helper()
        {
            StatementBuilder = StatementBuilderMapper.Get<FbConnection>();
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                item["ColumnDateTime2"] = UtcNowFirebirdPrecision();
        ...
        public static void UpdateBulkOperationMappedNonIdentityTables(List<BulkOperationMappedNonIdentityTable> tables)
        {
            ...
            foreach (var table in tables)
            {
                ...
                table.ColumnDateTime2Mapped = UtcNowFirebirdPrecision();
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                tables.Add(new
                {
                    ...
                    UnmatchedColumnDateTime2 = UtcNowFirebirdPrecision(),
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                item["UnmatchedColumnDateTime2"] = UtcNowFirebirdPrecision();
