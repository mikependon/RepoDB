...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for Firebird, exposed as <see cref="FbConnection"/>
    ...
    public static partial class FirebirdConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this FbConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this FbConnection connection,
            DataTable table,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this FbConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<FirebirdCommandBatcherMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this FbConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<FirebirdCommandBatcherMapItem> mappings = null,
            int? bulkCopyTimeout = null,
