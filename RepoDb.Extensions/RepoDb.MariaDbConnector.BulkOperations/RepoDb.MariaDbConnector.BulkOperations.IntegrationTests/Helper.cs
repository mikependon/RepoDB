...
namespace RepoDb.MariaDbConnector.BulkOperations.IntegrationTests
{
    /// <summary>
    ...
    public static class Helper
    {
        ...
        /// precision a MariaDB <c>DATETIME(6)</c> column (used for <c>ColumnDateTime2</c>/
        ...
        /// MariaDB on write, and a direct <see cref="DateTime"/> equality assertion between the in-memory
