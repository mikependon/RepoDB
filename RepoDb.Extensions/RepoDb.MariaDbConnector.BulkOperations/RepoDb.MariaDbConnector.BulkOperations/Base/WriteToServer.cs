    ...
    public static partial class MariaDbConnectionExtension
    {
            ...
            if (mappings != null)
            {
                ...
                foreach (var mapping in columnMappings)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new MariaDbBulkColumnMapping(sourceOrdinal, mapping.DestinationColumn));
                }
            }
            else
            {
                foreach (DataColumn column in table.Columns)
                {
                    ...
                    bulkCopy.ColumnMappings.Add(
                        new MariaDbBulkColumnMapping(table.Columns.IndexOf(column), column.ColumnName));
                }
            }
            return bulkCopy;
        }
            ...
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < columnMappings.Count; i++)
            {
                ...
                bulkCopy.ColumnMappings.Add(new MariaDbBulkColumnMapping(i, columnMappings[i].DestinationColumn));
            }
