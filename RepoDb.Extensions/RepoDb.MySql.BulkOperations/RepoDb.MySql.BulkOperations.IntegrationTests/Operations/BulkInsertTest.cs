...
namespace RepoDb.MySql.BulkOperations.IntegrationTests.Operations
{
    ...
    public class MySqlConnectionBulkInsertOperationsTest
    {
        ...
        public void TestMySqlConnectionBulkInsertForEntitiesWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsert(tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity);
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkInsertResult = destinationConnection.BulkInsert(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), table, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkInsertForTableNameExpandoObjectsWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsert(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkInsertAsyncForEntitiesWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsertAsync(tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity).Result;
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkInsertResult = destinationConnection.BulkInsertAsync(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), table, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity).Result;
        ...
        public void TestMySqlConnectionBulkInsertAsyncForTableNameExpandoObjectsWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsertAsync(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity).Result;
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationNonIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkInsertResult = destinationConnection.BulkInsert(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), table, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkInsertForNonIdentityTableNameExpandoObjectsWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsert(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity);
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationNonIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkInsertResult = destinationConnection.BulkInsertAsync(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), table, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity).Result;
        ...
        public void TestMySqlConnectionBulkInsertAsyncForNonIdentityTableNameExpandoObjectsWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkInsertResult = connection.BulkInsertAsync(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), tables, identityBehavior: MySqlBulkImportIdentityBehavior.ReturnIdentity).Result;
