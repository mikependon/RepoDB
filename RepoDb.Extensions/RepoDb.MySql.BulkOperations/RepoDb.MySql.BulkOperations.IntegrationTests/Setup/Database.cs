...
{
    /// <summary>
    /// A class used as a startup setup for the RepoDb MySql bulk-operations test database.
    /// </summary>
    public static class Database
    {
        ...
        /// <summary>
        /// Gets the connection string to be used for the MySql database.
        /// </summary>
        ...
        /// <c>CHAR(36)</c> column that MySql binds directly to/from <see cref="Guid"/> using its
