...
namespace RepoDb
{
    ...
    public static partial class MySqlConnectionExtension
    {
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        private static IEnumerable<MySqlBulkInsertMapItem> GetDefaultMappingsForDataReader(MySqlConnection connection,
            string tableName,
            IDataReader reader,
            MySqlTransaction transaction,
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < reader.FieldCount; i++)
            {
                ...
                {
                    yield return new MySqlBulkInsertMapItem(columnName, dbField.Name);
                }
            }
        }
