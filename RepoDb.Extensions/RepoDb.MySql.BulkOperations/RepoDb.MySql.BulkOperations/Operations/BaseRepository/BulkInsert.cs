...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the MySql bulk-insert
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        /// <param name="pseudoTableType">The type of staging (pseudo) table to create and reuse when <paramref name="identityBehavior"/> is <see cref="MySqlBulkImportIdentityBehavior.ReturnIdentity"/>.</param>
