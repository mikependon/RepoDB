...
namespace RepoDb.MySqlConnector.BulkOperations.IntegrationTests.Operations
{
    ...
    public class MySqlConnectionBulkMergeOperationsTest
    {
        ...
        public void TestMySqlConnectionBulkMergeForEntitiesForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMerge(tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkMergeForEntitiesWithMappings()
        {
            ...
            // Add the mappings
            mappings.Add(new MySqlConnectorBulkInsertMapItem(nameof(BulkOperationIdentityTable.Id), nameof(BulkOperationIdentityTable.Id)));
        ...
        public void TestMySqlConnectionBulkMergeForMappedEntitiesWithMappings()
        {
            ...
            // Add the mappings
            mappings.Add(new MySqlConnectorBulkInsertMapItem(nameof(BulkOperationMappedIdentityTable.IdMapped), nameof(BulkOperationIdentityTable.Id)));
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkMergeResult = destinationConnection.BulkMerge(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), table, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkMergeForTableNameExpandoObjectsForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMerge(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkMergeAsyncForEntitiesForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMergeAsync(tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity).Result;
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkMergeResult = destinationConnection.BulkMergeAsync(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), table, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity).Result;
        ...
        public void TestMySqlConnectionBulkMergeAsyncForTableNameExpandoObjectsForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMergeAsync(ClassMappedNameCache.Get<BulkOperationIdentityTable>(), tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity).Result;
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationNonIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkMergeResult = destinationConnection.BulkMerge(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), table, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity);
        ...
        public void TestMySqlConnectionBulkMergeForNonIdentityTableNameExpandoObjectsForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMerge(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity);
            ...
            using (var sourceConnection = new MySqlConnection(Database.ConnectionString))
            {
                ...
                using (var reader = sourceConnection.ExecuteReader("SELECT * FROM `BulkOperationNonIdentityTable`"))
                {
                    using (var table = new DataTable())
                    {
                        ...
                        {
                            // Act
                            var bulkMergeResult = destinationConnection.BulkMergeAsync(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), table, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity).Result;
        ...
        public void TestMySqlConnectionBulkMergeAsyncForNonIdentityTableNameExpandoObjectsForEmptyTableWithReturnIdentity()
        {
            ...
            {
                // Act
                var bulkMergeResult = connection.BulkMergeAsync(ClassMappedNameCache.Get<BulkOperationNonIdentityTable>(), tables, identityBehavior: MySqlConnectorBulkImportIdentityBehavior.ReturnIdentity).Result;
