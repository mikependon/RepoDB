...
namespace RepoDb.MySqlConnector.BulkOperations
{
    ...
    /// actually enumerated via <see cref="Read"/>. <see cref="MySqlConnector.ManagedDataAccess.Client.MySqlBulkCopy"/>
    ...
    /// <see cref="MySqlConnector.ManagedDataAccess.Client.MySqlBulkCopy.WriteToServer(IDataReader)"/> pulled
