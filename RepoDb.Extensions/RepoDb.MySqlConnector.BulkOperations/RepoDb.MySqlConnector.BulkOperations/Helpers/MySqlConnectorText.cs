...
{
    /// <summary>
    /// Builds every SQL text used by the MySqlConnector bulk-operations pseudo-table pipeline. This class was
    ...
    /// requires <c>AllowUserVariables=True</c> on the connection string - MySqlConnector defaults this to
    /// <see langword="false"/>.
    /// </summary>
    internal static class MySqlConnectorText
    {
        ...
        /// they assign it explicitly themselves. <c>MySqlConnectorBulkImportPseudoTableType.Physical</c>
            ...
            Field qualifierField = null)
        {
            ...
            var temporaryKeyword = pseudoTableType == MySqlConnectorBulkImportPseudoTableType.Physical
                ? string.Empty
                : "TEMPORARY ";
        ...
        /// MySqlConnector's documented behavior for a batched command.
        /// </remarks>
