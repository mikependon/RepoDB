...
{
    /// <summary>
    /// Thin execution layer over <see cref="MySqlConnectorText"/> - builds the SQL text for a step and runs it
    ...
    internal static class MySqlConnectorExecution
    {
        ...
        /// exist. See the remarks on <see cref="MySqlConnectorText.GetCreatePseudoTableSql"/>.
        /// </summary>
        ...
        /// <param name="qualifierField">When provided, the pseudo table is projected down to just this one column - see <see cref="MySqlConnectorText.GetCreatePseudoTableSql"/>.</param>
        ...
        /// same session before it is written to again. See the remarks on <see cref="MySqlConnectorText.GetTruncatePseudoTableSql"/>.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        ...
        /// see the remarks on <see cref="MySqlConnectorText.GetDropPseudoTableSql"/>.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        ...
        /// staging table column - see the remarks on <see cref="MySqlConnectorText.GetAllowNullForColumnSql"/> for why
        /// this exists.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        ...
        /// <paramref name="identityField"/> - see the remarks on <see cref="MySqlConnectorText.GetIdentitySequenceMetadataSql"/>
        ...
        /// order returned (see the remarks on <see cref="MySqlConnectorText.GetInsertFromPseudoTableForReturnIdentitySql"/>
        ...
        /// <see cref="MySqlConnectorText.GetMergeFromPseudoTableSql"/>.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        /// <param name="tableName">The name of the real, target table.</param>
        /// <param name="pseudoTableName">The name of the staging table that was bulk-written to.</param>
        ...
        /// <param name="identityField">The identity column, if any, to leave out of the <c>INSERT</c> column list - see the remarks on <see cref="MySqlConnectorText.GetMergeFromPseudoTableSql"/>.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="traceKey">The trace key to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        ...
        /// See the remarks on <see cref="MySqlConnectorText.GetUpdateFromPseudoTableSql"/>.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        /// <param name="tableName">The name of the real, target table.</param>
        /// <param name="pseudoTableName">The name of the staging table that was bulk-written to.</param>
        ...
        /// <paramref name="tableName"/> matched by a row currently staged in <paramref name="pseudoTableName"/>.
        /// See the remarks on <see cref="MySqlConnectorText.GetDeleteFromPseudoTableSql"/>.
        /// </summary>
        /// <param name="connection">The connection object to be used.</param>
        /// <param name="tableName">The name of the real, target table.</param>
        /// <param name="pseudoTableName">The name of the staging table that was bulk-written to.</param>
