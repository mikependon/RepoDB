...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            where TEntity : class =>
            repository.DbRepository.BulkInsert(ClassMappedNameCache.Get<TEntity>(), entities, mappings, bulkCopyTimeout, batchSize, identityBehavior, pseudoTableType, transaction);
        ...
        public static int BulkMerge<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            OracleTransaction transaction = null)
            where TEntity : class =>
            repository.DbRepository.BulkMerge(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, mappings, bulkCopyTimeout, batchSize, identityBehavior, pseudoTableType, transaction);
        ...
        public static int BulkUpdate<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            OracleTransaction transaction = null)
            where TEntity : class =>
            repository.DbRepository.BulkUpdate(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, mappings, bulkCopyTimeout, batchSize, pseudoTableType, transaction);
        ...
        public static int BulkDelete<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            OracleTransaction transaction = null)
            where TEntity : class =>
            repository.DbRepository.BulkDelete(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, bulkCopyTimeout, batchSize, pseudoTableType, transaction);
        ...
        public static Task<int> BulkInsertAsync<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            where TEntity : class =>
            repository.DbRepository.BulkInsertAsync(ClassMappedNameCache.Get<TEntity>(), entities, mappings, bulkCopyTimeout, batchSize, identityBehavior, pseudoTableType, transaction, cancellationToken);
        ...
        public static Task<int> BulkMergeAsync<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            CancellationToken cancellationToken = default)
            where TEntity : class =>
            repository.DbRepository.BulkMergeAsync(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, mappings, bulkCopyTimeout, batchSize, identityBehavior, pseudoTableType, transaction, cancellationToken);
        ...
        public static Task<int> BulkUpdateAsync<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            CancellationToken cancellationToken = default)
            where TEntity : class =>
            repository.DbRepository.BulkUpdateAsync(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, mappings, bulkCopyTimeout, batchSize, pseudoTableType, transaction, cancellationToken);
        ...
        public static Task<int> BulkDeleteAsync<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            CancellationToken cancellationToken = default)
            where TEntity : class =>
            repository.DbRepository.BulkDeleteAsync(ClassMappedNameCache.Get<TEntity>(), entities, qualifiers, bulkCopyTimeout, batchSize, pseudoTableType, transaction, cancellationToken);
