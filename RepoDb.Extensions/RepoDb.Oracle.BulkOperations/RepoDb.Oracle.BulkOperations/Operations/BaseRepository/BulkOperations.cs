...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            where TEntity : class =>
            repository.DbRepository.BulkInsert(ClassMappedNameCache.Get<TEntity>(), entities, mappings, bulkCopyTimeout, identityBehavior, transaction);
        ...
        public static Task<int> BulkInsertAsync<TEntity>(this BaseRepository<TEntity, OracleConnection> repository,
            ...
            where TEntity : class =>
            repository.DbRepository.BulkInsertAsync(ClassMappedNameCache.Get<TEntity>(), entities, mappings, bulkCopyTimeout, identityBehavior, transaction, cancellationToken);
