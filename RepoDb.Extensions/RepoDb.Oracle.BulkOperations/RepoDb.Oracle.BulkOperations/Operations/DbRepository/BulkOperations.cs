...
namespace RepoDb
{
    ...
    public static partial class DbRepositoryExtension
    {
            ...
            where TEntity : class
        {
            ...
            try
            {
                return connection.BulkMerge(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, identityBehavior, transaction);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
            ...
            where TEntity : class
        {
            ...
            try
            {
                return connection.BulkUpdate(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, transaction);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
            ...
            where TEntity : class
        {
            ...
            try
            {
                return connection.BulkDelete(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, transaction);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
            ...
            where TEntity : class
        {
            ...
            try
            {
                return await connection.BulkMergeAsync(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, identityBehavior, transaction, cancellationToken);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
            ...
            where TEntity : class
        {
            ...
            try
            {
                return await connection.BulkUpdateAsync(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, transaction, cancellationToken);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
            ...
            where TEntity : class
        {
            ...
            try
            {
                return await connection.BulkDeleteAsync(tableName ?? ClassMappedNameCache.Get<TEntity>(), entities, qualifiers != null ? Field.Parse(qualifiers) : null, bulkCopyTimeout, transaction, cancellationToken);
            }
            finally
            {
                DisposeIfOwned(repository, transaction, connection);
