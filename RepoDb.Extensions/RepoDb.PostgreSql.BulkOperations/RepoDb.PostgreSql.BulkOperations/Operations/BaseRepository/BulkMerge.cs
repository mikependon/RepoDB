...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        /// <returns>The number of rows that has been merged into the target table.</returns>
        public static async Task<int> BulkMergeAsync<TEntity>(this BaseRepository<TEntity, NpgsqlConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<Field> qualifiers = null,
            IEnumerable<PostgreSqlBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            ...
            where TEntity : class =>
            await repository.DbRepository.BulkMergeAsync<TEntity>(tableName: ClassMappedNameCache.Get<TEntity>(),
                    entities: entities,
                    qualifiers: qualifiers,
                    mappings: mappings,
                    bulkCopyTimeout: bulkCopyTimeout,
        ...
        public static async Task<int> BulkMergeAsync<TEntity>(this BaseRepository<TEntity, NpgsqlConnection> repository,
            ...
            CancellationToken cancellationToken = default)
            where TEntity : class =>
            await repository.DbRepository.BulkMergeAsync<TEntity>(tableName: (tableName ?? ClassMappedNameCache.Get<TEntity>()),
                    entities: entities,
                    qualifiers: qualifiers,
                    mappings: mappings,
                    bulkCopyTimeout: bulkCopyTimeout,
