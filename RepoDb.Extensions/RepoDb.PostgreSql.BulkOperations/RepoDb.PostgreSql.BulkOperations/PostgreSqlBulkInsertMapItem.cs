...
namespace RepoDb.PostgreSql.BulkOperations
{
    ...
    /// </summary>
    public class PostgreSqlBulkInsertMapItem : BulkInsertMapItem
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="PostgreSqlBulkInsertMapItem"/> object.
        /// </summary>
        ...
        public PostgreSqlBulkInsertMapItem(string sourceColumn,
