...
namespace RepoDb
{
    ...
    public static partial class SqlConnectionExtension
    {
        ...
        /// <returns></returns>
        private static int BulkMergeInternalBase<TEntity, TSqlBulkCopy, TSqlBulkCopyOptions,
        ...
        /// <returns></returns>
        private static async Task<int> BulkMergeAsyncInternalBase<TEntity, TSqlBulkCopy, TSqlBulkCopyOptions,
            TSqlBulkCopyColumnMappingCollection, TSqlBulkCopyColumnMapping, TSqlTransaction>(DbConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<Field> qualifiers = null,
