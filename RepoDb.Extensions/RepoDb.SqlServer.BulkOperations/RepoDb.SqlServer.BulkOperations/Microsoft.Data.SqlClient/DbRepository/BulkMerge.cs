...
namespace RepoDb
{
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkMerge(this DbRepository<SqlConnection> repository,
            ...
            SqlTransaction? transaction = null)
        {
            return BulkMerge(repository: repository,
                tableName: tableName,
                reader: reader,
                qualifiers: qualifiers,
                mappings: mappings,
        ...
        /// <returns>The number of rows affected by the execution.</returns>
        [Obsolete("This method is obsolete and will be removed in a future version. Use the overload that accepts 'SqlServerBulkImportIdentityBehavior' and 'SqlServerBulkImportPseudoTableType' instead of the 'isReturnIdentity' and 'usePhysicalPseudoTempTable' boolean flags.")]
        public static Task<int> BulkMergeAsync<TEntity>(this DbRepository<SqlConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>>? qualifiers = null,
            IEnumerable<SqlServerBulkInsertMapItem>? mappings = null,
            SqlBulkCopyOptions options = default,
        ...
        /// <returns>The number of rows affected by the execution.</returns>
        [Obsolete("This method is obsolete and will be removed in a future version. Use the overload that accepts 'SqlServerBulkImportPseudoTableType' instead of the 'usePhysicalPseudoTempTable' boolean flag.")]
        public static Task<int> BulkMergeAsync(this DbRepository<SqlConnection> repository,
            string tableName,
            DbDataReader reader,
            IEnumerable<Field>? qualifiers = null,
            IEnumerable<SqlServerBulkInsertMapItem>? mappings = null,
            ...
            CancellationToken cancellationToken = default)
        {
            return BulkMergeAsync(repository: repository,
                tableName: tableName,
                reader: reader,
                qualifiers: qualifiers,
                mappings: mappings,
