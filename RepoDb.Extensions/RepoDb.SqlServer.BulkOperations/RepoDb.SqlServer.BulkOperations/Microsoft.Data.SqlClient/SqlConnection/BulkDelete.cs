...
namespace RepoDb
{
    ...
    public static partial class SqlConnectionExtension
    {
        ...
        public static int BulkDelete<TEntity>(this SqlConnection connection,
            ...
            where TEntity : class
        {
            return BulkDelete<TEntity>(connection: connection,
        ...
        public static int BulkDelete(this SqlConnection connection,
            ...
            SqlTransaction? transaction = null)
        {
            return BulkDelete(connection: connection,
                tableName: tableName,
                primaryKeys: primaryKeys,
                hints: hints,
                bulkCopyTimeout: bulkCopyTimeout,
        ...
        public static Task<int> BulkDeleteAsync<TEntity>(this SqlConnection connection,
            ...
            where TEntity : class
        {
            return BulkDeleteAsync<TEntity>(connection: connection,
                primaryKeys: primaryKeys,
                hints: hints,
                bulkCopyTimeout: bulkCopyTimeout,
                batchSize: batchSize,
        ...
        public static Task<int> BulkDeleteAsync(this SqlConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return BulkDeleteAsync(connection: connection,
                tableName: tableName,
                primaryKeys: primaryKeys,
                hints: hints,
                bulkCopyTimeout: bulkCopyTimeout,
        ...
        internal static int BulkDeleteInternal(SqlConnection connection,
            ...
            BulkDeleteByKeyInternalBase(connection,
                tableName,
                primaryKeys,
                hints,
                bulkCopyTimeout,
        ...
        internal static Task<int> BulkDeleteAsyncInternal(SqlConnection connection,
            ...
            string? traceKey = null,
            CancellationToken cancellationToken = default) =>
            BulkDeleteByKeyAsyncInternalBase(connection,
                tableName,
                primaryKeys,
                hints,
                bulkCopyTimeout,
