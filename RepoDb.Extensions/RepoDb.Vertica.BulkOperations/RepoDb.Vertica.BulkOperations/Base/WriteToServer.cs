...
namespace RepoDb
{
    ...
    public static partial class VerticaConnectionExtension
    {
        ...
        /// <returns></returns>
        internal static int WriteToServerInternal(VerticaConnection connection,
            string tableName,
            DataTable table,
        ...
        /// <returns></returns>
        internal static async Task<int> WriteToServerAsyncInternal(VerticaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static VerticaBulkCopy CreateVerticaBulkCopy(VerticaConnection connection,
            string tableName,
        ...
        {
            var batcher = new VerticaBulkCopy(connection)
            {
            ...
            if (mappings != null)
            {
                ...
                {
                    batcher.ColumnMappings.Add(new VerticaBulkInsertMapItem(mapping.SourceColumn, mapping.DestinationColumn, mapping.Type));
                }
            }
            return batcher;
        }
        ...
        /// <returns></returns>
        private static VerticaBulkImportPseudoTableType ResolvePseudoTableType(VerticaBulkImportPseudoTableType pseudoTableType,
            int? rowCount) =>
            pseudoTableType == VerticaBulkImportPseudoTableType.Auto
                ? (rowCount.GetValueOrDefault() >= VerticaConstants.RowCountThresholdForPhysicalTable
                    ? VerticaBulkImportPseudoTableType.Physical
                    : VerticaBulkImportPseudoTableType.Memory)
                : pseudoTableType;
        ...
        /// finishing statement reads generated identities back per row (see <c>VerticaText</c>) - the value
        ...
        /// <param name="mappings"></param>
        /// <returns></returns>
        private static IEnumerable<VerticaBulkInsertMapItem> WithRowOrderMapping(IEnumerable<VerticaBulkInsertMapItem> mappings) =>
            mappings == null ? null : mappings.Append(new VerticaBulkInsertMapItem(RowOrderColumnName, RowOrderColumnName));
        ...
        /// <returns></returns>
        private static IEnumerable<VerticaBulkInsertMapItem> GetDefaultMappingsForDataTable(DataTable table,
        ...
        /// <param name="excludeField"></param>
        /// <returns></returns>
        private static IEnumerable<VerticaBulkInsertMapItem> GetDefaultMappingsForDataReader(VerticaConnection connection,
            string tableName,
            IDataReader reader,
            VerticaTransaction transaction,
            Field excludeField = null)
        {
            ...
            for (var i = 0; i < reader.FieldCount; i++)
            {
                ...
                {
                    yield return new VerticaBulkInsertMapItem(columnName, dbField.Name);
                }
            }
        }
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static DbCommand CreateTraceCommand(VerticaConnection connection,
            string commandText,
