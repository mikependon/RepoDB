...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this BaseRepository<TEntity, VerticaConnection> repository,
        ...
        /// <summary>
        /// Inserts a list of entities into the database in bulk, targeting an explicitly named table. Returns
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this BaseRepository<TEntity, VerticaConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <summary>
        /// Inserts a list of entities into the database in bulk in an asynchronous way, targeting an
        /// explicitly named table. Returns the number of inserted rows.
        /// </summary>
        /// <typeparam name="TEntity">The type of the data entity.</typeparam>
        /// <param name="repository">The repository object to be used.</param>
        /// <param name="tableName">The name of the target table.</param>
