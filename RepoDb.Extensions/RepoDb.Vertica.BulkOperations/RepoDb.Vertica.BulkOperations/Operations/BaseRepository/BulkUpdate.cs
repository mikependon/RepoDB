...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkUpdate<TEntity>(this BaseRepository<TEntity, VerticaConnection> repository,
        ...
        /// <returns>The number of updated rows.</returns>
        public static Task<int> BulkUpdateAsync<TEntity>(this BaseRepository<TEntity, VerticaConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
