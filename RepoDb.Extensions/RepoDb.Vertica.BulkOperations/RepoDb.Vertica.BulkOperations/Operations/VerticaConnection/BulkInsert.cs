...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for Vertica, exposed as <see cref="VerticaConnection"/>
    ...
    public static partial class VerticaConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this VerticaConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this VerticaConnection connection,
            DataTable table,
        ...
        public static int BulkInsert(this VerticaConnection connection,
            ...
            string traceKey = VerticaTraceKeys.VerticaBulkInsert,
            VerticaTransaction transaction = null) =>
            BulkInsertBase(connection, tableName, reader, mappings, bulkCopyTimeout, batchSize, trace, traceKey, transaction);
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this VerticaConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this VerticaConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        public static Task<int> BulkInsertAsync(this VerticaConnection connection,
            ...
            VerticaTransaction transaction = null,
            CancellationToken cancellationToken = default) =>
            BulkInsertBaseAsync(connection, tableName, reader, mappings, bulkCopyTimeout, batchSize, trace, traceKey, transaction, cancellationToken);
