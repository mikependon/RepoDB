...
namespace RepoDb.Firebird.IntegrationTests.Operations
{
    ...
    public class ExecuteScalarTest
    {
        ...
        [TestMethod]
        public void TestFirebirdConnectionExecuteScalar()
        {
            // Setup
        ...
        [TestMethod]
        public void TestFirebirdConnectionExecuteScalarWithReturnType()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionExecuteScalarAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionExecuteScalarAsyncWithReturnType()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
