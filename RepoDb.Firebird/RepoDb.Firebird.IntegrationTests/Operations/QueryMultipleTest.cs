...
namespace RepoDb.Firebird.IntegrationTests.Operations
{
    ...
    public class QueryMultipleTest
    {
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT2()
        {
            // Setup
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT2ViaId()
        {
            // Setup
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT3()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT3ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT4()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT4ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT5()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT5ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT6()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT6ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT7()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryMultipleForT7ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT2()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT2ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT3()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT3ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT4()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT4ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT5()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT5ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT6()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT6ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT7()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryMultipleAsyncForT7ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
