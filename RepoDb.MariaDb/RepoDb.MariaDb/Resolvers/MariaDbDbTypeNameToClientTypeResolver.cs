...
{
    /// <summary>
    /// A class used to resolve the MariaDb Database Types into its equivalent .NET CLR Types.
    /// </summary>
    public class MariaDbDbTypeNameToClientTypeResolver : IResolver<string, Type>
    {
        /// <summary>
