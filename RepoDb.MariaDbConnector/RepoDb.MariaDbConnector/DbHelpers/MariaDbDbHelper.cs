...
{
    /// <summary>
    /// A helper class for database specially for the direct access. This class is only meant for MariaDb.
    /// </summary>
    public sealed class MariaDbDbHelper : IDbHelper
    {
        ...
        /// </summary>
        public MariaDbDbHelper()
            : this(new MariaDbDbTypeNameToClientTypeResolver())
        { }
        ...
        public MariaDbDbHelper(IResolver<string, Type> dbTypeResolver)
        {
        ...
        /// <summary>
        /// Gets the type resolver used by this <see cref="MariaDbDbHelper"/> instance.
        /// </summary>
