...
namespace RepoDb.Oracle.IntegrationTests.Operations
{
    ...
    public class CountAllTest
    {
        ...
        [TestMethod]
        public void TestOracleConnectionCountAllWithAutomaticConversion()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public void TestOracleConnectionCountAllWithHintsThrows()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestOracleConnectionCountAllAsyncWithAutomaticConversion()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task TestOracleConnectionCountAllAsyncWithHintsThrows()
        {
            // Setup
            Database.CreateCompleteTables(10);
