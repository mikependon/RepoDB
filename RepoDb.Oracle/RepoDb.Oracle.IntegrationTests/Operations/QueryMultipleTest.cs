...
namespace RepoDb.Oracle.IntegrationTests.Operations
{
    ...
    /// every other provider. Only a representative subset of arities (T2-T4) is covered here rather
    /// than the full T2-T7 range, since each additional type is an additional round trip under the
    /// hood; TransactionTests.cs already exercises T2 through T7 (including within a transaction).
    ///
