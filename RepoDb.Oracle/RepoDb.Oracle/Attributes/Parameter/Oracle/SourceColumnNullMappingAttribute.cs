...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="OracleParameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(OracleParameter), nameof(OracleParameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
