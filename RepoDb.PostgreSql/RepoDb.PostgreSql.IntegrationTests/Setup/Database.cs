            ...
            using (var connection = new NpgsqlConnection(ConnectionString))
            {
                connection.ExecuteNonQuery(@"CREATE TABLE IF NOT EXISTS public.""CompleteTable""
                    (
                        ...
                        ""ColumnBigSerial"" bigint NOT NULL DEFAULT nextval('""CompleteTable_ColumnBigSerial_seq""'::regclass),
                        ""ColumnBit"" bit(1),
                        ...
                        ""ColumName"" name COLLATE pg_catalog.""C"",
                        ...
                        ""ColumnSerial"" integer NOT NULL DEFAULT nextval('""CompleteTable_ColumnSerial_seq""'::regclass),
                        ""ColumnSmallInt"" smallint,
                        ""ColumnSmallIntAsArray"" smallint[],
                        ""ColumnSmallSerial"" smallint NOT NULL DEFAULT nextval('""CompleteTable_ColumnSmallSerial_seq""'::regclass),
