    ...
    public class SumTest
    {
        ...
        public void TestSqLiteConnectionSumAsyncWithoutExpression()
        {
            using (var connection = new SQLiteConnection(Database.ConnectionStringSDS))
            {
                ...
                // Act
                var result = connection.SumAsync<SdsCompleteTable>(e => e.ColumnInt,
                    (object)null).Result;
        ...
        public void ThrowExceptionOnSqLiteConnectionSumAsyncWithHints()
        {
            using (var connection = new SQLiteConnection(Database.ConnectionStringSDS))
            {
                ...
                // Act
                connection.SumAsync<SdsCompleteTable>(e => e.ColumnInt,
                    (object)null,
                    hints: "WhatEver").Wait();
            }
        }
        ...
        public void TestSqLiteConnectionSumAsyncViaTableNameWithoutExpression()
        {
            using (var connection = new SQLiteConnection(Database.ConnectionStringSDS))
            {
                ...
                // Act
                var result = connection.SumAsync(ClassMappedNameCache.Get<SdsCompleteTable>(),
                    new Field("ColumnInt", typeof(int)),
                    (object)null).Result;
        ...
        public void ThrowExceptionOnSqLiteConnectionSumAsyncViaTableNameWithHints()
        {
            using (var connection = new SQLiteConnection(Database.ConnectionStringSDS))
            {
                ...
                // Act
                connection.SumAsync(ClassMappedNameCache.Get<SdsCompleteTable>(),
                    new Field("ColumnInt", typeof(int)),
                    (object)null,
                    hints: "WhatEver").Wait();
            }
