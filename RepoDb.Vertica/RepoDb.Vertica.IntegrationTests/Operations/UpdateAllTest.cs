...
namespace RepoDb.Vertica.IntegrationTests.Operations
{
    ...
    public class UpdateAllTest
    {
        ...
        [TestMethod]
        public void TestVerticaConnectionUpdateAll()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestVerticaConnectionUpdateAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestVerticaConnectionUpdateAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestVerticaConnectionUpdateAllViaTableNameAsExpandoObjects()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestVerticaConnectionUpdateAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestVerticaConnectionUpdateAllAsyncViaTableNameAsExpandoObjects()
        {
            // Setup
            var entities = Database.CreateCompleteTables(10).AsList();
