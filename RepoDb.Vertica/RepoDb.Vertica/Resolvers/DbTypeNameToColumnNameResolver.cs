...
{
    /// <summary>
    /// A class that is being used to resolve a Vertica database type name (e.g. <see cref="DbField.DatabaseType"/>)
    /// into its equivalent base Vertica column type keyword (e.g. <c>NUMERIC</c>, <c>VARCHAR</c>). Sized types
    ...
    {
        /// <summary>
        /// Returns the equivalent base Vertica column type keyword of the database type name.
        /// </summary>
