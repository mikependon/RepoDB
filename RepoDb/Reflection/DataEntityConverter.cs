...
{
    /// <summary>
    /// A mapper used to convert the <i>RepoDb.DataEntity</i> to certain objects (Dynamics, DataTable etc).
    /// </summary>
    public static class DataEntityConverter
    {
        /// <summary>
        /// Converts the list of <i>RepoDb.DataEntity</i> object into <i>System.DataTable</i> object.
        /// </summary>
        /// <typeparam name="TEntity">The type of <i>RepoDb.DataEntity</i> object.</typeparam>
        /// <param name="entities">The list of <i>RepoDb.DataEntity</i> object to be converted.</param>
