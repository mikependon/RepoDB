...
{
    /// <summary>
    /// A delegate used to map the <i>System.Data.Common.DbDataReader</i> into <i>RepoDb.Interfaces.DataEntity</i> object.
    /// </summary>
    /// <typeparam name="TEntity">The <i>RepoDb.Interfaces.DataEntity</i> object to map.</typeparam>
    /// <param name="dataReader">An instance of <i>System.Data.Common.DbDataReader</i> to be mapped.</param>
    /// <returns>An instance of <i>RepoDb.Interfaces.DataEntity</i> object containing the values from the <i>System.Data.Common.DbDataReader</i> object.</returns>
    ...
    /// <summary>
    /// A delegate used to convert the <i>RepoDb.Interfaces.DataEntity</i> object into <i>System.Data.DataRow</i> object.
    /// </summary>
    /// <typeparam name="TEntity">The <i>RepoDb.Interfaces.DataEntity</i> type to be converted.</typeparam>
    /// <param name="entity">The <i>RepoDb.Interfaces.DataEntity</i> object to be converted.</param>
