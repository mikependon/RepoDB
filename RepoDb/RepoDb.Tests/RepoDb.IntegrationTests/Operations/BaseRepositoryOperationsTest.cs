    ...
    public class BaseRepositoryOperationsTest
    {
        ...
        public void TestSqlConnectionExecuteQueryWithDictionaryParameters()
        {
            ...
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                var result = repository.ExecuteQuery("SELECT * FROM [dbo].[SimpleTable] WHERE ColumnFloat = @ColumnFloat AND ColumnInt = @ColumnInt;", param);
        ...
        public void TestSqlConnectionExecuteQueryWithExpandoObjectAsDynamicParameters()
        {
            ...
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                var result = repository.ExecuteQuery("SELECT * FROM [dbo].[SimpleTable] WHERE ColumnFloat = @ColumnFloat AND ColumnInt = @ColumnInt;", (object)param);
        ...
        public void ThrowExceptionOnTestSqlConnectionExecuteQueryIfTheParameterAreInvalidTypeDictionaryObject()
        {
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                repository.ExecuteQuery("SELECT * FROM [dbo].[SimpleTable] WHERE (Id = @Id);", param);
            }
        }
        ...
        public void TestSqlConnectionExecuteQueryAsyncWithDictionaryParameters()
        {
            ...
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                var result = repository.ExecuteQueryAsync("SELECT * FROM [dbo].[SimpleTable] WHERE ColumnFloat = @ColumnFloat AND ColumnInt = @ColumnInt;", param).Result;
        ...
        public void TestSqlConnectionExecuteQueryAsyncWithExpandoObjectAsDynamicParameters()
        {
            ...
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                var result = repository.ExecuteQueryAsync("SELECT * FROM [dbo].[SimpleTable] WHERE ColumnFloat = @ColumnFloat AND ColumnInt = @ColumnInt;", (object)param).Result;
        ...
        public void ThrowExceptionOnTestSqlConnectionExecuteQueryAsyncIfTheParameterAreInvalidTypeDictionaryObject()
        {
            using (var repository = new SimpleTableRepository())
            {
                ...
                // Act
                var result = repository.ExecuteQueryAsync("SELECT * FROM [dbo].[SimpleTable] WHERE (Id = @Id);", param).Result;
            }
        }
