...
namespace RepoDb.Extensions
{
    ...
    public static class PropertyInfoExtension
    {
        ...
        {
            return new QueryField(ClassExpression.GetPropertyMappedName(property), Operation.Equal, property.GetValue(entity), appendParameterPrefix);
        }
        ...
        {
            return $"{leftAlias}.[{ClassExpression.GetPropertyMappedName(property)}] = {rightAlias}.[{ClassExpression.GetPropertyMappedName(property)}]";
        }
        ...
        {
            return $"[{ClassExpression.GetPropertyMappedName(property)}]";
        }
