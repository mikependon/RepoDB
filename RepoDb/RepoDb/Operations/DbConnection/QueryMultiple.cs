...
namespace RepoDb
{
    ...
    public static partial class DbConnectionExtension
    {
        ...
        /// <param name="hints1">The table hints to be used (at T1). See <see cref="SqlTableHints"/> class.</param>
        ...
        /// <param name="hints2">The table hints to be used (at T2). See <see cref="SqlTableHints"/> class.</param>
        ...
        where T2 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                var item1 = DataReader.ToEnumerable<T1>((DbDataReader)reader, connection)?.ToList();

                // Extract the second result
                reader?.NextResult();
                var item2 = DataReader.ToEnumerable<T2>((DbDataReader)reader, connection)?.ToList();
        ...
        /// <param name="hints3">The table hints to be used (at T3). See <see cref="SqlTableHints"/> class.</param>
        /// <param name="commandTimeout">The command timeout in seconds to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="statementBuilder">The statement builder object to be used.</param>
            ...
            where T3 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                reader?.NextResult();
                var item3 = DataReader.ToEnumerable<T3>((DbDataReader)reader, connection)?.ToList();
        ...
        /// <param name="hints4">The table hints to be used (at T4). See <see cref="SqlTableHints"/> class.</param>
        /// <param name="commandTimeout">The command timeout in seconds to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="statementBuilder">The statement builder object to be used.</param>
            ...
            where T4 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                reader?.NextResult();
                var item4 = DataReader.ToEnumerable<T4>((DbDataReader)reader, connection)?.ToList();
        ...
        /// <param name="hints5">The table hints to be used (at T5). See <see cref="SqlTableHints"/> class.</param>
        /// <param name="commandTimeout">The command timeout in seconds to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="statementBuilder">The statement builder object to be used.</param>
            ...
            where T5 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                reader?.NextResult();
                var item5 = DataReader.ToEnumerable<T5>((DbDataReader)reader, connection)?.ToList();
        ...
        /// <param name="hints6">The table hints to be used (at T6). See <see cref="SqlTableHints"/> class.</param>
        /// <param name="commandTimeout">The command timeout in seconds to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="statementBuilder">The statement builder object to be used.</param>
            ...
            where T6 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                reader?.NextResult();
                var item6 = DataReader.ToEnumerable<T6>((DbDataReader)reader, connection)?.ToList();
        ...
        /// <param name="hints7">The table hints to be used (at T7). See <see cref="SqlTableHints"/> class.</param>
        /// <param name="commandTimeout">The command timeout in seconds to be used.</param>
        /// <param name="transaction">The transaction to be used.</param>
        /// <param name="trace">The trace object to be used.</param>
        /// <param name="statementBuilder">The statement builder object to be used.</param>
            ...
            where T7 : class
        {
                ...
                skipCommandArrayParametersCheck: true))
            {
                ...
                reader?.NextResult();
                var item7 = DataReader.ToEnumerable<T7>((DbDataReader)reader, connection)?.ToList();
