...
namespace RepoDb
{
        ...
        where TEntity : class
    {
        ...
        {
            var fields = DataEntityExtension.GetPropertiesFor<TEntity>(command)?.Select(property => PropertyMappedNameCache.Get(property).AsQuoted(true));
        ...
        {
            var fields = DataEntityExtension.GetPropertiesFor<TEntity>(command)?.Select(property => PropertyMappedNameCache.Get(property));
