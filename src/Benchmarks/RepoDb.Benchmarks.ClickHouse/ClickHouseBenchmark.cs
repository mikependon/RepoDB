...
namespace RepoDb.Benchmarks.ClickHouse
{
    public abstract class ClickHouseBenchmark : BaseBenchmark
    {
        [GlobalCleanup]
        ...
        protected override IDbConnection GetConnection() => new ClickHouseConnection(DatabaseHelper.ConnectionString);
    }
}
