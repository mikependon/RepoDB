...
using RepoDb.Benchmarks.EnterpriseDb.Models;
using RepoDb.Connector.EnterpriseDb;

namespace RepoDb.Benchmarks.EnterpriseDb.RepoDb
{
    public class InsertAllRepoDbBenchmarks : RepoDbBaseBenchmarks
    {
        ...
        {
            using var connection = GetConnection().EnsureOpen() as EDBConnection;
        ...
        {
            await using var connection = await GetConnection().EnsureOpenAsync().ConfigureAwait(false) as EDBConnection;
