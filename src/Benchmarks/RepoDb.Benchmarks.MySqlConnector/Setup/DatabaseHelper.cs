...
namespace RepoDb.Benchmarks.MySqlConnector.Setup
{
    public static class DatabaseHelper
    {
        ...
        {
            var adminConnectionString = Environment.GetEnvironmentVariable("REPODB_CONSTR_MYSQLDB", EnvironmentVariableTarget.Process);
            var connectionString = Environment.GetEnvironmentVariable("REPODB_CONSTR", EnvironmentVariableTarget.Process);

            AdminConnectionString = adminConnectionString ?? "Server=127.0.0.1;Port=3306;User Id=root;Password=RepoDB2026;";
            ConnectionString = connectionString ?? "Server=127.0.0.1;Port=3306;Database=RepoDb;User Id=root;Password=RepoDB2026;";
