...
using RepoDb.Benchmarks.Vertica.Models;
using Vertica.Data.VerticaClient;

namespace RepoDb.Benchmarks.Vertica.RepoDb
{
    public class InsertAllRepoDbBenchmarks : RepoDbBaseBenchmarks
    {
        ...
        {
            using var connection = GetConnection().EnsureOpen() as VerticaConnection;
        ...
        {
            await using var connection = await GetConnection().EnsureOpenAsync().ConfigureAwait(false) as VerticaConnection;
