...
/// <summary>
/// Contains the extension methods for <see cref="BaseRepository{TEntity, TDbConnection}"/> object that accept an <see cref="RepositoryUpdateOptions"/> object.
/// </summary>
public static partial class BaseRepositoryExtension
{
    ...
    public static int Update<TEntity, TDbConnection>(this BaseRepository<TEntity, TDbConnection> repository,
        TEntity entity,
        ...
        where TEntity : class
    {
        ...
        return repository.Update(entity: entity,
    ...
    /// <param name="options">The options to be used.</param>
    /// <returns>The number of rows that has been updated from the table.</returns>
    public static int Update<TEntity, TDbConnection, TWhat>(this BaseRepository<TEntity, TDbConnection> repository,
        TEntity entity,
        TWhat what,
        RepositoryUpdateOptions options)
        where TDbConnection : DbConnection, new()
    ...
    {
        options ??= new RepositoryUpdateOptions();
        return repository.Update<TWhat>(entity: entity,
            what: what,
            fields: options.Fields,
            hints: options.Hints,
            traceKey: options.TraceKey,
    ...
    /// <returns>The number of rows that has been updated from the table.</returns>
    public static Task<int> UpdateAsync<TEntity, TDbConnection>(this BaseRepository<TEntity, TDbConnection> repository,
        TEntity entity,
        RepositoryUpdateOptions options,
    ...
    {
        options ??= new RepositoryUpdateOptions();
        return repository.UpdateAsync(entity: entity,
            fields: options.Fields,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The number of rows that has been updated from the table.</returns>
    public static Task<int> UpdateAsync<TEntity, TDbConnection, TWhat>(this BaseRepository<TEntity, TDbConnection> repository,
        TEntity entity,
        TWhat what,
        RepositoryUpdateOptions options,
        CancellationToken cancellationToken = default)
    ...
    {
        options ??= new RepositoryUpdateOptions();
        return repository.UpdateAsync<TWhat>(entity: entity,
            what: what,
            fields: options.Fields,
            hints: options.Hints,
            traceKey: options.TraceKey,
