...
/// <summary>
/// Contains the extension methods for <see cref="DbRepository{TDbConnection}"/> object that accept a <see cref="RepositoryDeleteOptions"/> object.
/// </summary>
public static partial class DbRepositoryExtension
{
    ...
    public static int Delete<TEntity, TDbConnection>(this DbRepository<TDbConnection> repository,
        TEntity entity,
        ...
        where TEntity : class
    {
        ...
        return repository.Delete<TEntity>(entity: entity,
            hints: options.Hints,
    ...
    /// <param name="options">The options to be used.</param>
    /// <returns>The number of rows that has been deleted from the table.</returns>
    public static int Delete<TEntity, TDbConnection, TWhat>(this DbRepository<TDbConnection> repository,
        TWhat what,
        RepositoryDeleteOptions options)
        where TDbConnection : DbConnection, new()
        where TEntity : class
    {
        options ??= new RepositoryDeleteOptions();
        return repository.Delete<TEntity, TWhat>(what: what,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction);
    }
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.Delete<TEntity>(what: what,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction);
    }
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.Delete<TEntity>(where: where,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction);
    }
    ...
    /// <returns>The number of rows that has been deleted from the table.</returns>
    public static Task<int> DeleteAsync<TEntity, TDbConnection>(this DbRepository<TDbConnection> repository,
        TEntity entity,
        RepositoryDeleteOptions options,
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.DeleteAsync<TEntity>(entity: entity,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The number of rows that has been deleted from the table.</returns>
    public static Task<int> DeleteAsync<TEntity, TDbConnection, TWhat>(this DbRepository<TDbConnection> repository,
        TWhat what,
        RepositoryDeleteOptions options,
        CancellationToken cancellationToken = default)
        where TDbConnection : DbConnection, new()
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.DeleteAsync<TEntity, TWhat>(what: what,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction,
            cancellationToken: cancellationToken);
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.DeleteAsync<TEntity>(what: what,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction,
            cancellationToken: cancellationToken);
    ...
    {
        options ??= new RepositoryDeleteOptions();
        return repository.DeleteAsync<TEntity>(where: where,
            hints: options.Hints,
            traceKey: options.TraceKey,
            transaction: options.Transaction,
            cancellationToken: cancellationToken);
