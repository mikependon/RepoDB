...
/// <summary>
/// A class that holds the optional arguments for the 'Insert' operation of the <see cref="BaseRepository{TEntity, TDbConnection}"/> and <see cref="DbRepository{TDbConnection}"/> objects.
/// </summary>
public class RepositoryInsertOptions
{
    /// <summary>
