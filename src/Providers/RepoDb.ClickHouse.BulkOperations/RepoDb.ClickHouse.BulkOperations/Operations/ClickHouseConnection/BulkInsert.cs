...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for ClickHouse, exposed as <see cref="ClickHouseConnection"/>
    ...
    public static partial class ClickHouseConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this ClickHouseConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this ClickHouseConnection connection,
            DataTable table,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this ClickHouseConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this ClickHouseConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<ClickHouseBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
