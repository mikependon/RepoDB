...
namespace RepoDb.CockroachDb.BulkOperations.IntegrationTests
{
    /// <summary>
    ...
    public static class Helper
    {
        static Helper()
        {
            StatementBuilder = StatementBuilderMapper.Get<CockroachDbConnection>();
        ...
        /// precision a Postgres/CockroachDB <c>TIMESTAMP(6)</c> column (used for <c>ColumnDateTime2</c>/
        ...
        /// Postgres/CockroachDB on write, and a direct <see cref="DateTime"/> equality assertion between the
        /// in-memory value and the value read back from the database would fail.
        /// </summary>
