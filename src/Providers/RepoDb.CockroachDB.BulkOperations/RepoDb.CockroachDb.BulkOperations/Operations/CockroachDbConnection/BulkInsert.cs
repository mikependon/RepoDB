...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for CockroachDB, exposed as <see cref="CockroachDbConnection"/>
    ...
    public static partial class CockroachDbConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this CockroachDbConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this CockroachDbConnection connection,
            DataTable table,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this CockroachDbConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<CockroachDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this CockroachDbConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<CockroachDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
