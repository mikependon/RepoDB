...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrapper for the CockroachDB bulk-delete-by-key operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this DbRepository<CockroachDbConnection> repository,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static async Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this DbRepository<CockroachDbConnection> repository,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
