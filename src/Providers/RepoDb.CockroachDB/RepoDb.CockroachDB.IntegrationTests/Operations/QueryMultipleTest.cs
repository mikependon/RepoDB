...
namespace RepoDb.CockroachDB.IntegrationTests.Operations
{
    ...
    public class QueryMultipleTest
    {
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT2()
        {
            // Setup
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT2ViaId()
        {
            // Setup
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT3()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT3ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT4()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT4ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT5()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT5ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT6()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT6ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT7()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryMultipleForT7ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT2()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT2ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT3()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT3ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT4()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT4ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT5()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT5ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT6()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT6ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT7()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryMultipleAsyncForT7ViaId()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).AsList();
