...
namespace RepoDb.CockroachDB.IntegrationTests.Operations
{
    ...
    public class UpdateTest
    {
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaDataEntity()
        {
            // Setup
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaExpression()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaDataEntity()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaExpression()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaExpandoObject()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaDataEntity()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateViaTableNameViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaExpandoObject()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaDataEntity()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAsyncViaTableNameViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(1).First();
            var queryFields = new[]
