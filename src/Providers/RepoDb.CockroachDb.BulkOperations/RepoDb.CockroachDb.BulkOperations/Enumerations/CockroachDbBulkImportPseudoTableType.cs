...
namespace RepoDb.Enumerations.CockroachDb
{
    /// <summary>
    /// Specifies what kind of staging table backs a <c>BulkMerge</c>, <c>BulkUpdate</c>, or <c>BulkDelete</c>
    /// operation against CockroachDB.
    /// </summary>
    public enum CockroachDbBulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="CockroachDbConstants.RowCountThresholdForPhysicalTable"/>, otherwise selects
