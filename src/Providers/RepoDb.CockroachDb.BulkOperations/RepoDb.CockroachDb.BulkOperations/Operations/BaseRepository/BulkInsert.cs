...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the CockroachDB bulk-insert
    /// operation.
    /// </summary>
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this BaseRepository<TEntity, CockroachDbConnection> repository,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this BaseRepository<TEntity, CockroachDbConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<CockroachDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
