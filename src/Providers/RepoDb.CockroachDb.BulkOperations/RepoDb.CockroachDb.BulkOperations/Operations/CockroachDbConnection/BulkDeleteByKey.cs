...
namespace RepoDb
{
    public static partial class CockroachDbConnectionExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this CockroachDbConnection connection,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this CockroachDbConnection connection,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
