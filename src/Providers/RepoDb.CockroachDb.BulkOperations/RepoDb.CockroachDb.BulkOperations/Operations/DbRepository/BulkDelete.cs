...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the CockroachDB bulk-delete operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkDelete<TEntity>(this DbRepository<CockroachDbConnection> repository,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static async Task<int> BulkDeleteAsync<TEntity>(this DbRepository<CockroachDbConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        private static void DisposeIfOwned(DbRepository<CockroachDbConnection> repository,
