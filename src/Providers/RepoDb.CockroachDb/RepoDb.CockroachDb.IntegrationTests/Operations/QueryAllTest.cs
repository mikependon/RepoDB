...
namespace RepoDb.CockroachDB.IntegrationTests.Operations
{
    ...
    public class QueryAllTest
    {
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionQueryAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionQueryAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
