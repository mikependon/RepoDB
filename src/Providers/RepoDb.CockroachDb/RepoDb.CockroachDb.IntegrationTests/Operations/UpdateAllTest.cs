...
namespace RepoDb.CockroachDb.IntegrationTests.Operations
{
    ...
    public class UpdateAllTest
    {
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateAll()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestCockroachDbConnectionUpdateAllViaTableNameAsExpandoObjects()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestCockroachDbConnectionUpdateAllAsyncViaTableNameAsExpandoObjects()
        {
            // Setup
            var entities = Database.CreateCompleteTables(10).AsList();
