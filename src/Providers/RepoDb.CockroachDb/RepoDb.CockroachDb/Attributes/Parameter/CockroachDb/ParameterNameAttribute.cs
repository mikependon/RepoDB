...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="CockroachDbParameter.ParameterName"/>
    ...
    public class ParameterNameAttribute : PropertyValueAttribute
    {
        ...
        public ParameterNameAttribute(string parameterName)
            : base(typeof(CockroachDbParameter), nameof(CockroachDbParameter.ParameterName), parameterName)
        { }
