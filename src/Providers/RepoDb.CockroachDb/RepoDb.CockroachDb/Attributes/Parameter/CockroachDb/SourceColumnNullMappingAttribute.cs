...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="CockroachDbParameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(CockroachDbParameter), nameof(CockroachDbParameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
