...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="CockroachDbParameter.SourceVersion"/>
    ...
    public class SourceVersionAttribute : PropertyValueAttribute
    {
        ...
        public SourceVersionAttribute(DataRowVersion sourceVersion)
            : base(typeof(CockroachDbParameter), nameof(CockroachDbParameter.SourceVersion), sourceVersion)
        { }
