...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="CockroachDbParameter.Value"/>
    ...
    public class ValueAttribute : PropertyValueAttribute
    {
        ...
        public ValueAttribute(object value)
            : base(typeof(CockroachDbParameter), nameof(CockroachDbParameter.Value), value)
        { }
