...
{
    /// <summary>
    /// A helper class for database specially for the direct access. This class is only meant for CockroachDB.
    /// </summary>
    public sealed class CockroachDbDbHelper : IDbHelper
    {
        private readonly IDbSetting m_dbSetting = new CockroachDbDbSetting();

        /// <summary>
        /// Creates a new instance of <see cref="CockroachDbDbHelper"/> class.
        /// </summary>
        public CockroachDbDbHelper()
            : this(new CockroachDbDbTypeNameToClientTypeResolver())
        { }
        ...
        public CockroachDbDbHelper(IResolver<string, Type> dbTypeResolver)
        {
        ...
        /// <summary>
        /// Gets the type resolver used by this <see cref="CockroachDbDbHelper"/> instance.
        /// </summary>
        ...
        private void HandleDbParameterPostCreation(IDbDataParameter parameter)
        {
            ...
            {
                HandleArrayDbParameterPostCreation(parameter as CockroachDbParameter, sourceArray);
                return;
            }
        ...
        private void HandleArrayDbParameterPostCreation(CockroachDbParameter parameter, Array sourceArray)
        {
            if (parameter == null)
            {
                return;
