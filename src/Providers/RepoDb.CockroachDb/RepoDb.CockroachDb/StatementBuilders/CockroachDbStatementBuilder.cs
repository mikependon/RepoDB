...
{
    /// <summary>
    /// A class used to build a SQL Statement for CockroachDB.
    /// </summary>
    public sealed class CockroachDbStatementBuilder : BaseStatementBuilder
    {
        /// <summary>
        /// Creates a new instance of <see cref="CockroachDbStatementBuilder"/> object.
        /// </summary>
        public CockroachDbStatementBuilder()
            : this(DbSettingMapper.Get<CockroachDbConnection>(),
                  new CockroachDbConvertFieldResolver(),
                  new ClientTypeToAverageableClientTypeResolver())
        { }

        /// <summary>
        /// Creates a new instance of <see cref="CockroachDbStatementBuilder"/> class.
        /// </summary>
            ...
            string hints = null)
        {
            ...
            // The sub-table expression is failing on the INSERT statement.
            ...
            //    var databaseType = (dbType != null) ? new DbTypeToCockroachDbStringNameResolver().Resolve(dbType.Value) : null;
        ...
        private string GetDatabaseType(DbField dbField)
        {
            ...
            return dbType.HasValue ?
                new DbTypeToCockroachDbStringNameResolver().Resolve(dbType.Value) : null;
        }
