...
namespace RepoDb.IntegrationTests
{
    ...
    public class ExecuteListParameterTest
    {
        ...
        public void TestSqlConnectionExecuteQueryWithListParameterAsDynamic()
        {
            ...
            {
                // Act
                tables.ForEach(item => item.Id = Convert.ToInt32(connection.Insert(item), System.Globalization.CultureInfo.InvariantCulture));
        ...
        public async Task TestSqlConnectionExecuteQueryAsyncWithListParameterAsDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    table.Id = Convert.ToInt32(await connection.InsertAsync(table).ConfigureAwait(false), System.Globalization.CultureInfo.InvariantCulture);
                }
        ...
        public async Task TestDbRepositoryExecuteQueryAsyncWithListParameterAsDynamic()
        {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                foreach (var table in tables)
                {
                    table.Id = Convert.ToInt32(await repository.InsertAsync(table).ConfigureAwait(false), System.Globalization.CultureInfo.InvariantCulture);
                }
