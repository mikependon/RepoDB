    ...
    public class AverageAllTest
    {
        ...
        public async Task TestSqlConnectionAverageAllAsync()
        {
            ...
            await using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.AverageAllAsync<IdentityTable>(e => e.ColumnInt).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionAverageAllAsyncTypedResult()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.AverageAllAsync<IdentityTable, double?>(e => e.ColumnInt).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionAverageAllAsyncTypedResultDecimal()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.AverageAllAsync<IdentityTable, decimal?>(e => e.ColumnDecimal).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionAverageAllAsyncTypedResultDouble()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.AverageAllAsync<IdentityTable, double?>(e => e.ColumnFloat).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionAverageAllTypedResultDecimalAsyncViaTableName()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                var result = await connection.AverageAllAsync<decimal?>(ClassMappedNameCache.Get<IdentityTable>(),
                    new Field("ColumnDecimal", typeof(decimal))).ConfigureAwait(false);
