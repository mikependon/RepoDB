    ...
    public class CountTest
    {
        ...
        public async Task TestSqlConnectionCountAsyncWithoutCondition()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>((object)null).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionCountAsyncViaExpression()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>(item => item.ColumnInt >= 2 && item.ColumnInt <= 8).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionCountAsyncViaDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>(new { ColumnInt = 1 }).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionCountAsyncViaQueryField()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>(field).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionCountAsyncViaQueryFields()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>(fields).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionCountAsyncViaQueryGroup()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.CountAsync<IdentityTable>(queryGroup).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionCountAsyncViaTableNameWithoutCondition()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public async Task TestSqlConnectionCountAsyncViaTableNameViaDynamic()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public async Task TestSqlConnectionCountAsyncViaTableNameViaQueryField()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var field = new QueryField(nameof(IdentityTable.ColumnInt), Operation.GreaterThan, 5);
        ...
        [TestMethod]
        public async Task TestSqlConnectionCountAsyncViaTableNameViaQueryFields()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var fields = new[]
        ...
        [TestMethod]
        public async Task TestSqlConnectionCountAsyncViaTableNameViaQueryGroup()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var fields = new[]
        ...
        [TestMethod]
        public void TestSqlConnectionCountViaViaTableNameWithoutCondition()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public void TestSqlConnectionCountViaViaTableNameViaDynamic()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public void TestSqlConnectionCountViaViaTableNameViaQueryField()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var field = new QueryField(nameof(IdentityTable.ColumnInt), Operation.GreaterThan, 5);
        ...
        [TestMethod]
        public void TestSqlConnectionCountViaViaTableNameViaQueryFields()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var fields = new[]
        ...
        [TestMethod]
        public void TestSqlConnectionCountViaViaTableNameViaQueryGroup()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            var fields = new[]
