...
namespace RepoDb.IntegrationTests.Operations
{
    ...
    public class DeleteTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncWithoutCondition2()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>((object)null).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncWithEmptyQueryFields2()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(Enumerable.Empty<QueryField>()).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncWithHints()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    var result = await connection.DeleteAsync<IdentityTable>(table, hints: SqlServerTableHints.TabLock).ConfigureAwait(false);
                    Assert.AreEqual(1, result);
                }
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDataEntityViaPrimaryKey()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    // Act
                    var result = await connection.DeleteAsync<IdentityTable>(item.Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDataEntityViaPrimaryKeyAsObject()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    // Act
                    var result = await connection.DeleteAsync<IdentityTable>((object)item.Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDataEntityViaPrimaryKeyAsType()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    // Act
                    var result = await connection.DeleteAsync<IdentityTable, long>(item.Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDataEntity()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    // Act
                    var result = await connection.DeleteAsync<IdentityTable>(item).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncAsyncWithoutCondition()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncAsyncWithEmptyQueryFields()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaPrimaryKey()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(last.Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(new { ColumnInt = 6 }).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaExpression()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(c => c.ColumnInt == last.Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaQueryField()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(field).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaQueryFields()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(fields).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaQueryGroup()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync<IdentityTable>(queryGroup).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaDataEntityWithHints()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                {
                    // Act
                    var result = await connection.DeleteAsync<IdentityTable>(item, hints: SqlServerTableHints.TabLock).ConfigureAwait(false);
        ...
        [TestMethod]
        public void TestSqlConnectionDeleteViaDataEntityWithHints()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncViaTableNameWithoutCondition2()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncViaTableNameWithoutConditionButWithHints2()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaTableNameWithPrimaryKeyAsObject()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync(ClassMappedNameCache.Get<IdentityTable>(),
                    (object)tables.First().Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaTableNameWithPrimaryKey()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync(ClassMappedNameCache.Get<IdentityTable>(),
                    tables.First().Id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaTableNameAsEntity()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync(ClassMappedNameCache.Get<IdentityTable>(),
                    tables.First()).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncAsyncViaTableNameWithoutCondition()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        public async Task TestSqlConnectionDeleteAsyncViaTableNameViaDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.DeleteAsync(ClassMappedNameCache.Get<IdentityTable>(),
                    new { ColumnInt = 6 }).ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestSqlConnectionDeleteAsyncAsyncViaTableNameWithoutConditionButWithHints()
        {
            // Setup
            var tables = Helper.CreateIdentityTables(10);
        ...
        public async Task ThrowExceptionOnSqlConnectionDeleteAsyncViaTableNameIfThereIsNoKeyField()
        {
            ...
            {
                await Assert.ThrowsAsync<KeyFieldNotFoundException>(async () => await connection.DeleteAsync(ClassMappedNameCache.Get<NonKeyedTable>(), 1).ConfigureAwait(false)).ConfigureAwait(false);
            }
        }
