    ...
    public class MinAllTest
    {
        ...
        public async Task TestSqlConnectionMinAllAsync()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MinAllAsync<IdentityTable>(e => e.ColumnInt).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionMinAllAsyncTypedResult()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MinAllAsync<IdentityTable, int?>(e => e.ColumnInt).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionMinAllAsyncTypedResultDateTime()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MinAllAsync<IdentityTable, DateTime?>(e => e.ColumnDateTime).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionMinAllAsyncTypedResultDouble()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MinAllAsync<IdentityTable, double?>(e => e.ColumnFloat).ConfigureAwait(false);
