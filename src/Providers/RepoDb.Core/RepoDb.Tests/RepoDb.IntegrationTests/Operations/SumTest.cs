    ...
    public class SumTest
    {
        ...
        public void TestSqlConnectionSumWithoutCondition()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Sum(t => t.ColumnInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public void TestSqlConnectionSumViaExpression()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(t => t.ColumnInt > 5 && t.ColumnInt <= 8).Sum(t => t.ColumnInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public void TestSqlConnectionSumViaDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(t => t.ColumnInt == 1).Sum(t => t.ColumnInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public void TestSqlConnectionSumViaQueryField()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(t => t.ColumnInt > 5).Sum(t => t.ColumnInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public async Task TestSqlConnectionSumAsyncTypedResultDecimalViaExpression()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.SumAsync<IdentityTable, decimal?>(e => e.ColumnDecimal,
                    item => item.ColumnDecimal > 5m && item.ColumnDecimal <= 8m).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionSumAsyncTypedResultDecimalViaDynamic()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.SumAsync<IdentityTable, decimal?>(e => e.ColumnDecimal,
                    new { ColumnDecimal = 1m }).ConfigureAwait(false);
