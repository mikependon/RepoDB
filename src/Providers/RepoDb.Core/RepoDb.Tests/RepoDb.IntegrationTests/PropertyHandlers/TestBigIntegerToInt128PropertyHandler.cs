...
{
    /// <summary>
    /// The integration tests of <see cref="BigIntegerToInt128PropertyHandler"/>. The handler targets 128-bit integer columns that the driver exposes as a
    ...
    /// </summary>
    [TestClass]
    public class BigIntegerToInt128PropertyHandlerTest
    {
        [TestInitialize]
        ...
        private class AttributeModel
        {
            ...
            [Map("ColumnBigInt"), PropertyHandler(typeof(BigIntegerToInt128PropertyHandler))]
        ...
        private class OnIntColumnModel
        {
            ...
            [Map("ColumnInt"), PropertyHandler(typeof(BigIntegerToInt128PropertyHandler))]
            public Int128 Value { get; set; }
        }
        ...
        private class OnDecimalColumnModel
        {
            ...
            [Map("ColumnDecimal"), PropertyHandler(typeof(BigIntegerToInt128PropertyHandler))]
            public Int128 Value { get; set; }
        }
        ...
        private class OnSmallIntColumnModel
        {
            ...
            [Map("ColumnSmallInt"), PropertyHandler(typeof(BigIntegerToInt128PropertyHandler))]
            public Int128 Value { get; set; }
        }
        ...
        private class OnStringColumnModel
        {
            ...
            [Map("ColumnNVarChar"), PropertyHandler(typeof(BigIntegerToInt128PropertyHandler))]
            public Int128 Value { get; set; }
        }
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandler()
        {
        ...
        [TestMethod]
        public async Task TestBigIntegerToInt128PropertyHandlerAsync()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        public void TestBigIntegerToInt128PropertyHandlerReadsTheBigIntColumn(long value)
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        public void TestBigIntegerToInt128PropertyHandlerReadsTheIntColumn(int value)
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerOnQueryAll()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerOnExecuteQuery()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerViaFluentMapper()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                FluentMapper
                    .Entity<FluentModel>()
                    .PropertyHandler(e => e.ColumnBigInt, new BigIntegerToInt128PropertyHandler());
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerViaTypeLevelMapper()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                PropertyHandlerMapper.Add<Int128, BigIntegerToInt128PropertyHandler>(true);
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWithNullColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                ...
                // Assert
                Assert.AreEqual(default(Int128), result.Value);
            }
        }

        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWithNullIntColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWriteOfValueIsNotSupported()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWriteOfValueIsNotSupportedDoesNotWriteAnyRow()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWithDecimalColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWithSmallIntColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToInt128PropertyHandlerWithTextColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
