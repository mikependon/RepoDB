...
{
    /// <summary>
    /// The integration tests of <see cref="BigIntegerToNullableInt128PropertyHandler"/>. The handler targets 128-bit integer columns that the driver exposes as a
    ...
    /// </summary>
    [TestClass]
    public class BigIntegerToNullableInt128PropertyHandlerTest
    {
        [TestInitialize]
        ...
        public void Cleanup()
        {
            PropertyHandlerMapper.Remove(typeof(Int128?));
        ...
        private class AttributeModel
        {
            ...
            [Map("ColumnBigInt"), PropertyHandler(typeof(BigIntegerToNullableInt128PropertyHandler))]
        ...
        private class OnIntColumnModel
        {
            ...
            [Map("ColumnInt"), PropertyHandler(typeof(BigIntegerToNullableInt128PropertyHandler))]
            public Int128? Value { get; set; }
        }
        ...
        private class FluentModel
        {
            ...
            public Int128? ColumnBigInt { get; set; }
        }

        /// <summary>
        /// Type level: the handler is bound to <see cref="Int128"/> via <see cref="PropertyHandlerMapper"/>.
        /// </summary>
        [Map("[dbo].[CompleteTable]")]
        ...
        private class OnDecimalColumnModel
        {
            ...
            [Map("ColumnDecimal"), PropertyHandler(typeof(BigIntegerToNullableInt128PropertyHandler))]
            public Int128? Value { get; set; }
        }
        ...
        private class OnSmallIntColumnModel
        {
            ...
            [Map("ColumnSmallInt"), PropertyHandler(typeof(BigIntegerToNullableInt128PropertyHandler))]
            public Int128? Value { get; set; }
        }
        ...
        private class OnStringColumnModel
        {
            ...
            [Map("ColumnNVarChar"), PropertyHandler(typeof(BigIntegerToNullableInt128PropertyHandler))]
            public Int128? Value { get; set; }
        }
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandler()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual((Int128?)5, result.Value);
            }
        }

        [TestMethod]
        public async Task TestBigIntegerToNullableInt128PropertyHandlerAsync()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        public void TestBigIntegerToNullableInt128PropertyHandlerReadsTheBigIntColumn(long value)
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                ...
                // Assert
                Assert.AreEqual((Int128?)value, result.Value);
            }
        }
        ...
        public void TestBigIntegerToNullableInt128PropertyHandlerReadsTheIntColumn(int value)
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerOnQueryAll()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                ...
                {
                    Assert.AreEqual((Int128?)((i + 1) * 1000), result.First(e => e.SessionId == sessionIds[i]).Value);
                }
            }
        }

        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerOnExecuteQuery()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                ...
                // Assert
                Assert.AreEqual((Int128?)77, result.Value);
            }
        }

        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerViaFluentMapper()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                FluentMapper
                    .Entity<FluentModel>()
                    .PropertyHandler(e => e.ColumnBigInt, new BigIntegerToNullableInt128PropertyHandler());
                ...
                // Assert
                Assert.AreEqual((Int128?)88, result.ColumnBigInt);
            }
        }

        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerViaTypeLevelMapper()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                PropertyHandlerMapper.Add<Int128?, BigIntegerToNullableInt128PropertyHandler>(true);
                ...
                // Assert
                Assert.AreEqual((Int128?)99, result.ColumnBigInt);
            }
        }

        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithNullValueWritesNull()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public async Task TestBigIntegerToNullableInt128PropertyHandlerWithNullValueWritesNullAsync()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerOnInsertAllWithNullValues()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerUpdateToNullValue()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithNullColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithNullIntColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWriteOfValueIsNotSupported()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
                // The handler writes a 'BigInteger', which the SQL Server driver cannot convert to the parameter of the 'BIGINT' column
                var model = new AttributeModel { SessionId = Guid.NewGuid(), Value = (Int128?)42 };
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWriteOfValueIsNotSupportedDoesNotWriteAnyRow()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithDecimalColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithSmallIntColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
        ...
        [TestMethod]
        public void TestBigIntegerToNullableInt128PropertyHandlerWithTextColumn()
        {
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                // Setup
