...
namespace RepoDb.IntegrationTests.Types.Bytes
{
    ...
    public class SqlConnectionBytesTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesCrudAsync2()
        {
            // Setup
            var text = "RepoDb"; // Helper.GetAssemblyDescription();
            var bytes = Encoding.UTF8.GetBytes(text);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<BytesClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesNullCrudAsync2()
        {
            // Setup
            var entity = new BytesClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesMappedCrudAsync2()
        {
            // Setup
            var text = "RepoDb"; // Helper.GetAssemblyDescription();
            var bytes = Encoding.UTF8.GetBytes(text);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<BytesMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesMappedNullCrudAsync2()
        {
            // Setup
            var entity = new BytesMapClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesCrudViaTableNameAsync2()
        {
            // Setup
            var text = "RepoDb"; // Helper.GetAssemblyDescription();
            var bytes = Encoding.UTF8.GetBytes(text);
            ...
            {
                // Act Insert
                var id = await connection.InsertAsync(ClassMappedNameCache.Get<BytesClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await connection.QueryAsync(ClassMappedNameCache.Get<BytesClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionBytesNullCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
