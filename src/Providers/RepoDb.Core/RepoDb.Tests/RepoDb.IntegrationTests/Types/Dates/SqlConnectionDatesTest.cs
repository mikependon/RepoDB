...
namespace RepoDb.IntegrationTests.Types.Dates
{
    ...
    public class SqlConnectionDatesTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesCrudAsync2()
        {
            // Setup
            var dateTime = new DateTime(1970, 1, 1, 12, 50, 30, DateTimeKind.Utc);
            var dateTime2 = dateTime.AddMilliseconds(100);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<DatesClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesNullCrudAsync2()
        {
            // Setup
            var entity = new DatesClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesMappedCrudAsync2()
        {
            // Setup
            var dateTime = new DateTime(1970, 1, 1, 12, 50, 30, DateTimeKind.Utc);
            var dateTime2 = dateTime.AddMilliseconds(100);
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<DatesMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesMappedNullCrudAsync2()
        {
            // Setup
            var entity = new DatesMapClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesCrudViaTableNameAsync2()
        {
            // Setup
            var dateTime = new DateTime(1970, 1, 1, 12, 50, 30, DateTimeKind.Utc);
            var dateTime2 = dateTime.AddMilliseconds(100);
            ...
            {
                // Act Insert
                var id = await connection.InsertAsync(ClassMappedNameCache.Get<DatesClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await connection.QueryAsync(ClassMappedNameCache.Get<DatesClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionDatesNullCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
