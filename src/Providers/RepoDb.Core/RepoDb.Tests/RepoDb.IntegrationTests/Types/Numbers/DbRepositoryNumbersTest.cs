...
namespace RepoDb.IntegrationTests.Types.Numbers
{
    ...
    public class DbRepositoryNumbersTest
    {
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<NumbersClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersMappedCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<NumbersMappedClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersMappedNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
            ...
            {
                // Act Insert
                var id = await repository.InsertAsync(ClassMappedNameCache.Get<NumbersClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await repository.QueryAsync(ClassMappedNameCache.Get<NumbersClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryNumbersNullViaTableNameCrudAsync()
        {
            // Setup
            var entity = new
            {
