...
namespace RepoDb.IntegrationTests.Types.Numbers
{
    ...
    public class SqlConnectionNumbersTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<NumbersClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersMappedCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<NumbersMappedClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersMappedNullCrudAsync2()
        {
            // Setup
            var entity = new NumbersMappedClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
