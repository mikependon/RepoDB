...
namespace RepoDb.IntegrationTests.Types.Others
{
    ...
    public class DbRepositoryOthersTest
    {
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersCrudAsync2()
        {
            // Setup
            var entity = new OthersClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<OthersClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersNullCrudAsync2()
        {
            // Setup
            var entity = new OthersClass
            {
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersMappedCrudAsync2()
        {
            // Setup
            var entity = new OthersMapClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<OthersMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersMappedNullCrudAsync2()
        {
            // Setup
            var entity = new OthersMapClass
            {
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
            ...
            {
                // Act Insert
                var id = await repository.InsertAsync(ClassMappedNameCache.Get<OthersClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await repository.QueryAsync(ClassMappedNameCache.Get<OthersClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositoryOthersNullCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
