...
namespace RepoDb.IntegrationTests.Types.Others
{
    ...
    public class SqlConnectionOthersTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersCrudAsync2()
        {
            // Setup
            var entity = new OthersClass
            {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<OthersClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersNullCrudAsync2()
        {
            // Setup
            var entity = new OthersClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersMappedCrudAsync2()
        {
            // Setup
            var entity = new OthersMapClass
            {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<OthersMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersMappedNullCrudAsync2()
        {
            // Setup
            var entity = new OthersMapClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionOthersNullCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
