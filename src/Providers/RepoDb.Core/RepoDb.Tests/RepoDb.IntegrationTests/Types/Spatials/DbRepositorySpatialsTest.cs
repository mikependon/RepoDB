...
namespace RepoDb.IntegrationTests.Types.Spatials
{
    ...
    public class DbRepositorySpatialsTest
    {
        ...
        [TestMethod]
        public async Task TestDbRepositorySpatialsCrudAsync2()
        {
            // Setup
            var entity = new SpatialsClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<SpatialsClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositorySpatialsNullCrudAsync2()
        {
            // Setup
            var entity = new SpatialsClass
            {
        ...
        [TestMethod]
        public async Task TestDbRepositorySpatialsMappedCrudAsync2()
        {
            // Setup
            var entity = new SpatialsMapClass
            {
            ...
            using (var repository = new DbRepository<SqlConnection>(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await repository.QueryAsync<SpatialsMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestDbRepositorySpatialsMappedNullCrudAsync2()
        {
            // Setup
            var entity = new SpatialsMapClass
            {
        ...
        public void TestSqlConnectionSpatialsCrudViaTableName()
        {
            ...
            {
                // Act Insert
                var id = repository.Insert(ClassMappedNameCache.Get<SpatialsClass>(), entity);

                // Act Query
                var data = repository.Query(ClassMappedNameCache.Get<SpatialsClass>(), new { SessionId = (Guid)id }).FirstOrDefault();
        ...
        public async Task TestSqlConnectionSpatialsCrudViaTableNameAsync2()
        {
            ...
            {
                // Act Insert
                var id = await repository.InsertAsync(ClassMappedNameCache.Get<SpatialsClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await repository.QueryAsync(ClassMappedNameCache.Get<SpatialsClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        public void TestSqlConnectionSpatialsCrudViaTableNameAsync()
        {
            ...
            {
                // Act Insert
                var insertResult = repository.InsertAsync(ClassMappedNameCache.Get<SpatialsClass>(), entity);
                var id = insertResult.Result;

                // Act Query
                var queryResult = repository.QueryAsync(ClassMappedNameCache.Get<SpatialsClass>(), new { SessionId = (Guid)id });
                var data = queryResult.Result.FirstOrDefault();
