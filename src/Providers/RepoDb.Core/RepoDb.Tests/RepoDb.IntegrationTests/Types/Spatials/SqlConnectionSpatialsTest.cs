    ...
    public class SqlConnectionSpatialsTest
    {
        ...
        public async Task TestSqlConnectionSpatialsCrudAsync2()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<SpatialsClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        public async Task TestSqlConnectionSpatialsMappedCrudAsync2()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<SpatialsMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
