    ...
    public class SqlConnectionNumbersTest
    {
        ...
        public async Task TestSqlConnectionNumbersCrudAsync()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var queryResult = await connection.QueryAsync<NumbersClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false);
        ...
        public async Task TestSqlConnectionNumbersMappedCrudAsync()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var queryResult = await connection.QueryAsync<NumbersMappedClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false);
                var data = queryResult.FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersCrudViaTableNameAsync()
        {
            // Setup
            var entity = new
            {
            ...
            {
                // Act Insert
                var id = await connection.InsertAsync(ClassMappedNameCache.Get<NumbersClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await connection.QueryAsync(ClassMappedNameCache.Get<NumbersClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionNumbersNullViaTableNameCrudAsync()
        {
            // Setup
            var entity = new
            {
        ...
        public async Task TestSqlConnectionNumbersCrudViaAsyncViaTableName()
        {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var queryResult = await connection.QueryAsync(ClassMappedNameCache.Get<NumbersClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false);
                var data = queryResult.FirstOrDefault();
        ...
        [TestMethod]
        public void TestSqlConnectionNumbersCrudViaViaTableName()
        {
            // Setup
            var entity = new
            {
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var queryResult = connection.Query(ClassMappedNameCache.Get<NumbersClass>(), new { SessionId = (Guid)id });
                var data = queryResult.FirstOrDefault();
        ...
        [TestMethod]
        public void TestSqlConnectionNumbersNullCrudViaViaTableName()
        {
            // Setup
            var entity = new
            {
