...
namespace RepoDb.IntegrationTests.Types.Strings
{
    ...
    public class SqlConnectionStringsTest
    {
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsCrudAsync2()
        {
            // Setup
            var text = Helper.GetUnicodeString();
            var entity = new StringsClass
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<StringsClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsNullCrudAsync2()
        {
            // Setup
            var entity = new StringsClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsMappedCrudAsync2()
        {
            // Setup
            var text = Helper.GetUnicodeString();
            var entity = new StringsMapClass
            ...
            using (var connection = new SqlConnection(Database.ConnectionString))
            {
                ...
                // Act Query
                var data = (await connection.QueryAsync<StringsMapClass>(e => e.SessionId == (Guid)id).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsMappedNullCrudAsync2()
        {
            // Setup
            var entity = new StringsMapClass
            {
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsCrudViaTableNameAsync2()
        {
            // Setup
            var text = Helper.GetUnicodeString();
            var entity = new
            ...
            {
                // Act Insert
                var id = await connection.InsertAsync(ClassMappedNameCache.Get<StringsClass>(), entity).ConfigureAwait(false);

                // Act Query
                var data = (await connection.QueryAsync(ClassMappedNameCache.Get<StringsClass>(), new { SessionId = (Guid)id }).ConfigureAwait(false)).FirstOrDefault();
        ...
        [TestMethod]
        public async Task TestSqlConnectionStringsNullCrudViaTableNameAsync2()
        {
            // Setup
            var entity = new
            {
