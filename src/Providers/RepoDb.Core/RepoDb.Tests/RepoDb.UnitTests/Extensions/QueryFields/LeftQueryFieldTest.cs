...
namespace RepoDb.UnitTests.Extensions.QueryFields
{
    ...
    public class LeftQueryFieldTest
    {
        ...
        public void TestLeftQueryFieldConstructor()
        {
            ...
            Assert.AreEqual("LEFT({0}, 5)", functionalQueryField.Format, StringComparer.Ordinal);
        }
        ...
        public void TestLeftQueryFieldGetString()
        {
            ...
            // Assert
            Assert.AreEqual("LEFT([FieldName], 5) = @FieldName", text, StringComparer.Ordinal);
        }
        ...
        public void TestLeftQueryFieldGetStringWithIndex()
        {
            ...
            // Assert
            Assert.AreEqual("LEFT([FieldName], 5) = @FieldName_1", text, StringComparer.Ordinal);
        }
    }
}
