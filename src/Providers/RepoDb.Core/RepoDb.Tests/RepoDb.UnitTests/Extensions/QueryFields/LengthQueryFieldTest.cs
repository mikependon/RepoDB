...
namespace RepoDb.UnitTests.Extensions.QueryFields
{
    ...
    public class LengthQueryFieldTest
    {
        ...
        public void TestLengthQueryFieldConstructor()
        {
            ...
            Assert.AreEqual("LENGTH({0})", functionalQueryField.Format, StringComparer.Ordinal);
        }
        ...
        public void TestLengthQueryFieldGetString()
        {
            ...
            // Assert
            Assert.AreEqual("LENGTH([FieldName]) = @FieldName", text, StringComparer.Ordinal);
        }
        ...
        public void TestLengthQueryFieldGetStringWithIndex()
        {
            ...
            // Assert
            Assert.AreEqual("LENGTH([FieldName]) = @FieldName_1", text, StringComparer.Ordinal);
        }
    }
}
