...
namespace RepoDb.UnitTests.Extensions.QueryFields
{
    ...
    public class LowerQueryFieldTest
    {
        ...
        public void TestLowerQueryFieldConstructor()
        {
            ...
            Assert.AreEqual("LOWER({0})", functionalQueryField.Format, StringComparer.Ordinal);
        }
        ...
        public void TestLowerQueryFieldGetString()
        {
            ...
            // Assert
            Assert.AreEqual("LOWER([FieldName]) = @FieldName", text, StringComparer.Ordinal);
        }
        ...
        public void TestLowerQueryFieldGetStringWithIndex()
        {
            ...
            // Assert
            Assert.AreEqual("LOWER([FieldName]) = @FieldName_1", text, StringComparer.Ordinal);
        }
    }
}
