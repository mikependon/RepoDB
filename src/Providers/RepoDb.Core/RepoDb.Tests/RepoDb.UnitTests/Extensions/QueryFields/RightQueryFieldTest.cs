...
namespace RepoDb.UnitTests.Extensions.QueryFields
{
    ...
    public class RightQueryFieldTest
    {
        ...
        public void TestRightQueryFieldConstructor()
        {
            ...
            Assert.AreEqual("RIGHT({0}, 5)", functionalQueryField.Format, StringComparer.Ordinal);
        }
        ...
        public void TestRightQueryFieldGetString()
        {
            ...
            // Assert
            Assert.AreEqual("RIGHT([FieldName], 5) = @FieldName", text, StringComparer.Ordinal);
        }
        ...
        public void TestRightQueryFieldGetStringWithIndex()
        {
            ...
            // Assert
            Assert.AreEqual("RIGHT([FieldName], 5) = @FieldName_1", text, StringComparer.Ordinal);
        }
    }
}
