...
namespace RepoDb.UnitTests.Extensions.QueryFields
{
    ...
    public class UpperQueryFieldTest
    {
        ...
        public void TestUpperQueryFieldConstructor()
        {
            ...
            Assert.AreEqual("UPPER({0})", functionalQueryField.Format, StringComparer.Ordinal);
        }
        ...
        public void TestUpperQueryFieldGetString()
        {
            ...
            // Assert
            Assert.AreEqual("UPPER([FieldName]) = @FieldName", text, StringComparer.Ordinal);
        }
        ...
        public void TestUpperQueryFieldGetStringWithIndex()
        {
            ...
            // Assert
            Assert.AreEqual("UPPER([FieldName]) = @FieldName_1", text, StringComparer.Ordinal);
        }
    }
}
