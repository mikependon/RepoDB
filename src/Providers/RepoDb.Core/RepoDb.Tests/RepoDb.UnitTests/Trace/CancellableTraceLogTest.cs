...
namespace RepoDb.UnitTests.Trace
{
    ...
    public class CancellableTraceLogTest
    {
        ...
        [TestMethod]
        public void ThrowExceptionOnExecuteQueryFirstCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                connection
                    .ExecuteQueryFirst("", trace: new ErroneousCancellationTrace());
            });
        }

        [TestMethod]
        public async Task ThrowExceptionOnExecuteQueryFirstAsyncCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .ExecuteQueryFirstAsync("", trace: new ErroneousCancellationTrace()).ConfigureAwait(false);
            }).ConfigureAwait(false);
        }

        [TestMethod]
        public void ThrowExceptionOnExecuteQueryFirstIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task ThrowExceptionOnExecuteQueryFirstAsyncIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .ExecuteQueryFirstAsync("").ConfigureAwait(false);
            }).ConfigureAwait(false);
        }
        ...
        [TestMethod]
        public void ThrowExceptionOnExecuteQuerySingleCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                connection
                    .ExecuteQuerySingle("", trace: new ErroneousCancellationTrace());
            });
        }

        [TestMethod]
        public async Task ThrowExceptionOnExecuteQuerySingleAsyncCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .ExecuteQuerySingleAsync("", trace: new ErroneousCancellationTrace()).ConfigureAwait(false);
            }).ConfigureAwait(false);
        }

        [TestMethod]
        public void ThrowExceptionOnExecuteQuerySingleIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task ThrowExceptionOnExecuteQuerySingleAsyncIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .ExecuteQuerySingleAsync("").ConfigureAwait(false);
            }).ConfigureAwait(false);
        }
        ...
        [TestMethod]
        public void ThrowExceptionOnQuerySingleCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                connection
                    .QuerySingle("", (QueryField)null, trace: new ErroneousCancellationTrace());
            });
        }

        [TestMethod]
        public async Task ThrowExceptionOnQuerySingleAsyncCancelledOperation()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .QuerySingleAsync("", (QueryField)null, trace: new ErroneousCancellationTrace()).ConfigureAwait(false);
            }).ConfigureAwait(false);
        }

        [TestMethod]
        public void ThrowExceptionOnQuerySingleIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                connection
                    .QuerySingle("", (QueryField)null);
            });
        }

        [TestMethod]
        public async Task ThrowExceptionOnQuerySingleAsyncIfNoRowsFound()
        {
            // Prepare
            var connection = new TraceDbConnection();
            ...
            {
                await connection
                    .QuerySingleAsync("", (QueryField)null).ConfigureAwait(false);
            }).ConfigureAwait(false);
        }
        ...
        [TestMethod]
        public void TestDbConnectionTraceSilentCancellationForExecuteQueryFirst()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task TestDbConnectionTraceSilentCancellationForExecuteQueryFirstAsync()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
            ...
            // Act
            await connection
                .ExecuteQueryFirstAsync("", trace: trace).ConfigureAwait(false)
                ;
        ...
        [TestMethod]
        public void TestDbConnectionTraceSilentCancellationForExecuteQuerySingle()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
            ...
            // Act
            connection
                .ExecuteQuerySingle("", trace: trace);
        ...
        [TestMethod]
        public async Task TestDbConnectionTraceSilentCancellationForExecuteQuerySingleAsync()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
            ...
            // Act
            await connection
                .ExecuteQuerySingleAsync("", trace: trace).ConfigureAwait(false)
                ;
        ...
        [TestMethod]
        public void TestDbConnectionTraceSilentCancellationForQuerySingle()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
            ...
            // Act
            connection.QuerySingle<TraceEntity>(te => te.Id == 1,
                trace: trace);
        ...
        [TestMethod]
        public async Task TestDbConnectionTraceSilentCancellationForQuerySingleAsync()
        {
            // Prepare
            var trace = new SilentCancellationTrace();
            var connection = new TraceDbConnection();
            ...
            // Act
            await connection.QuerySingleAsync<TraceEntity>(te => te.Id == 1,
                trace: trace).ConfigureAwait(false);
        ...
        [TestMethod]
        public void TestDbConnectionTracePropertiesForExecuteQueryFirst()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task TestDbConnectionTracePropertiesForExecuteQueryFirstAsync()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public void TestDbConnectionTracePropertiesForExecuteQuerySingle()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task TestDbConnectionTracePropertiesForExecuteQuerySingleAsync()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public void TestDbConnectionTracePropertiesForQuerySingle()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
        ...
        [TestMethod]
        public async Task TestDbConnectionTracePropertiesForQuerySingleAsync()
        {
            // Prepare
            var trace = new PropertyValidatorTrace();
            var connection = new TraceDbConnection();
