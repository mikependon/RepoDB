...
namespace RepoDb
{
    ...
    public static partial class DbConnectionExtension
    {
        ...
        public static dynamic ExecuteQueryFirst(this IDbConnection connection,
            ...
            string cacheKey = null,
            int? cacheItemExpiration = Constant.DefaultCacheItemExpirationInMinutes,
            string traceKey = TraceKeys.ExecuteQueryFirst,
            int? commandTimeout = null,
            IDbTransaction transaction = null,
            ICache cache = null,
            ITrace trace = null)
        {
            return ExecuteQueryFirstInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
        ...
        /// <param name="skipCommandArrayParametersCheck"></param>
        /// <returns></returns>
        internal static dynamic ExecuteQueryFirstInternal(this IDbConnection connection,
            string commandText,
            object param = null,
            CommandType? commandType = null,
            string cacheKey = null,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (cache != null && cacheKey != null)
            {
                var item = cache.Get<object>(cacheKey, throwException: false);
                if (item != null)
                {
                    return item.Value;
                }
            ...
            using (var reader = command.ExecuteReader())
            {
                ...
                foreach (var item in DataReader.ToEnumerable(reader, dbFields, connection.GetDbSetting()))
                {
                    result = item;
                    found = true;
                    break;
                ...
                if (!found)
                {
                    throw new EmptyException("No row was found for the given query.");
                }
        ...
        public static Task<dynamic> ExecuteQueryFirstAsync(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return ExecuteQueryFirstAsyncInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
        ...
        /// <param name="skipCommandArrayParametersCheck"></param>
        /// <returns></returns>
        internal static async Task<dynamic> ExecuteQueryFirstAsyncInternal(this IDbConnection connection,
            string commandText,
            object param = null,
            CommandType? commandType = null,
            string cacheKey = null,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (cache != null && cacheKey != null)
            {
                var item = await cache.GetAsync<object>(cacheKey, throwException: false, cancellationToken).ConfigureAwait(false);
                if (item != null)
                {
                    return item.Value;
                }
            ...
            using (var reader = await command.ExecuteReaderAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                await foreach (var item in DataReader.ToEnumerableAsync(reader, dbFields, connection.GetDbSetting(), cancellationToken).ConfigureAwait(false))
                {
                    result = item;
                    found = true;
                    break;
        ...
        #region ExecuteQueryFirst<TResult>

        /// <summary>
        /// Executes a SQL statement from the database. It uses the underlying method of <see cref="IDbCommand.ExecuteReader(CommandBehavior)"/> and
        /// converts the first row of the result back to an instance of the target result type.
        /// </summary>
        /// <typeparam name="TResult">The type of the result.</typeparam>
        /// <param name="connection">The connection object to be used.</param>
        /// <param name="commandText">The command text to be used.</param>
        ...
        public static TResult ExecuteQueryFirst<TResult>(this IDbConnection connection,
            ...
            ITrace trace = null)
        {
            return ExecuteQueryFirstInternal<TResult>(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (TypeCache.Get(typeOfResult).IsDictionaryStringObject() || typeOfResult.IsObjectType())
            {
                return ExecuteQueryFirstInternalForDictionaryStringObject<TResult>(connection: connection,
                    commandText: commandText,
                    param: param,
                    commandType: commandType,
                    cacheKey: cacheKey,
            ...
            {
                return ExecuteQueryFirstInternalForType<TResult>(connection: connection,
                    commandText: commandText,
                    param: param,
                    commandType: commandType,
                    cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            // Call
            object row = ExecuteQueryFirstInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: null,
            ...
            var result = new object[] { row }.WithType<TResult>().First();
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            using (var reader = command.ExecuteReader())
            {
                ...
                foreach (var item in DataReader.ToEnumerable<TResult>(reader, dbFields, connection.GetDbSetting()))
                {
                    result = item;
                    found = true;
                    break;
        ...
        #region ExecuteQueryFirstAsync<TResult>
        ...
        public static Task<TResult> ExecuteQueryFirstAsync<TResult>(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return ExecuteQueryFirstAsyncInternal<TResult>(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (TypeCache.Get(typeOfResult).IsDictionaryStringObject() || typeOfResult.IsObjectType())
            {
                return await ExecuteQueryFirstAsyncInternalForDictionaryStringObject<TResult>(connection: connection,
                   commandText: commandText,
                   param: param,
                   commandType: commandType,
                   cacheKey: cacheKey,
            ...
            {
                return await ExecuteQueryFirstAsyncInternalForType<TResult>(connection: connection,
                   commandText: commandText,
                   param: param,
                   commandType: commandType,
                   cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            // Call
            object row = await ExecuteQueryFirstAsyncInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: null,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            using (var reader = await command.ExecuteReaderAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                await foreach (var item in DataReader.ToEnumerableAsync<TResult>(reader, dbFields, connection.GetDbSetting(), cancellationToken).ConfigureAwait(false))
                {
                    result = item;
                    found = true;
                    break;
        ...
        public static dynamic ExecuteQuerySingle(this IDbConnection connection,
            ...
            string cacheKey = null,
            int? cacheItemExpiration = Constant.DefaultCacheItemExpirationInMinutes,
            string traceKey = TraceKeys.ExecuteQuerySingle,
            int? commandTimeout = null,
            IDbTransaction transaction = null,
            ICache cache = null,
            ITrace trace = null)
        {
            return ExecuteQuerySingleInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
        ...
        /// <param name="skipCommandArrayParametersCheck"></param>
        /// <returns></returns>
        internal static dynamic ExecuteQuerySingleInternal(this IDbConnection connection,
            string commandText,
            object param = null,
            CommandType? commandType = null,
            string cacheKey = null,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            using (var reader = command.ExecuteReader())
            {
                ...
                if (count > 1)
                {
                    throw new MultipleRowsFoundException("More than one row was found for the given query.");
                }
        ...
        public static Task<dynamic> ExecuteQuerySingleAsync(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return ExecuteQuerySingleAsyncInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
        ...
        /// <param name="skipCommandArrayParametersCheck"></param>
        /// <returns></returns>
        internal static async Task<dynamic> ExecuteQuerySingleAsyncInternal(this IDbConnection connection,
            string commandText,
            object param = null,
            CommandType? commandType = null,
            string cacheKey = null,
        ...
        #region ExecuteQuerySingle<TResult>

        /// <summary>
        /// Executes a SQL statement from the database. It uses the underlying method of <see cref="IDbCommand.ExecuteReader(CommandBehavior)"/> and
        /// converts the single row of the result back to an instance of the target result type.
        /// </summary>
        /// <typeparam name="TResult">The type of the result.</typeparam>
        /// <param name="connection">The connection object to be used.</param>
        /// <param name="commandText">The command text to be used.</param>
        ...
        /// <param name="trace">The trace object to be used.</param>
        /// <returns>
        /// An instance of the target result type containing the converted result of the single row returned by the underlying <see cref="IDataReader"/> object.
        /// </returns>
        /// <remarks>
        /// An <see cref="EmptyException"/> is thrown if the query did not return any row.
        /// A <see cref="MultipleRowsFoundException"/> is thrown if the query returned more than one row.
        ...
        public static TResult ExecuteQuerySingle<TResult>(this IDbConnection connection,
            ...
            ITrace trace = null)
        {
            return ExecuteQuerySingleInternal<TResult>(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (TypeCache.Get(typeOfResult).IsDictionaryStringObject() || typeOfResult.IsObjectType())
            {
                return ExecuteQuerySingleInternalForDictionaryStringObject<TResult>(connection: connection,
                    commandText: commandText,
                    param: param,
                    commandType: commandType,
                    cacheKey: cacheKey,
            ...
            {
                return ExecuteQuerySingleInternalForType<TResult>(connection: connection,
                    commandText: commandText,
                    param: param,
                    commandType: commandType,
                    cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            // Call
            object row = ExecuteQuerySingleInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: null,
        ...
        #region ExecuteQuerySingleAsync<TResult>
        ...
        public static Task<TResult> ExecuteQuerySingleAsync<TResult>(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return ExecuteQuerySingleAsyncInternal<TResult>(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            if (TypeCache.Get(typeOfResult).IsDictionaryStringObject() || typeOfResult.IsObjectType())
            {
                return await ExecuteQuerySingleAsyncInternalForDictionaryStringObject<TResult>(connection: connection,
                   commandText: commandText,
                   param: param,
                   commandType: commandType,
                   cacheKey: cacheKey,
            ...
            {
                return await ExecuteQuerySingleAsyncInternalForType<TResult>(connection: connection,
                   commandText: commandText,
                   param: param,
                   commandType: commandType,
                   cacheKey: cacheKey,
            ...
            bool skipCommandArrayParametersCheck = true)
        {
            ...
            // Call
            object row = await ExecuteQuerySingleAsyncInternal(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: null,
