...
namespace RepoDb
{
        ...
        where TEntity : class
    {
        ...
        public EntityMapFluentDefinition<TEntity> Column(Expression<Func<TEntity, object>> expression,
            string columnName)
        {
            return Column(expression, columnName, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> Column(string propertyName,
            string columnName)
        {
            return Column(propertyName, columnName, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> Column(Field field,
            string columnName)
        {
            return Column(field, columnName, force: false);
        }
        ...
        {
            return Primary(expression, force: false);
        }
        ...
        {
            return Primary(propertyName, force: false);
        }
        ...
        {
            return Primary(field, force: false);
        }
        ...
        {
            return Identity(expression, force: false);
        }
        ...
        {
            return Identity(propertyName, force: false);
        }
        ...
        {
            return Identity(field, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> DbType(Expression<Func<TEntity, object>> expression,
            DbType? dbType)
        {
            return DbType(expression, dbType, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> DbType(string propertyName,
            DbType? dbType)
        {
            return DbType(propertyName, dbType, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> DbType(Field field,
            DbType? dbType)
        {
            return DbType(field, dbType, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> PropertyHandler<TPropertyHandler>(Expression<Func<TEntity, object>> expression,
            ...
            where TPropertyHandler : new()
        {
            return PropertyHandler(expression, new TPropertyHandler(), force);
        }
        ...
        {
            return PropertyValueAttributes(expression, attributes, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> PropertyValueAttributes(string propertyName,
            IEnumerable<PropertyValueAttribute> attributes)
        {
            return PropertyValueAttributes(propertyName, attributes, force: false);
        }
        ...
        public EntityMapFluentDefinition<TEntity> PropertyValueAttributes(Field field,
            IEnumerable<PropertyValueAttribute> attributes)
        {
            return PropertyValueAttributes(field, attributes, force: false);
        }
