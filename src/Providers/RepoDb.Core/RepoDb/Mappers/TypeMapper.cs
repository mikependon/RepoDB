...
namespace RepoDb
{
    ...
    public static class TypeMapper
    {
        ...
        public static void Add<TEntity>(Expression<Func<TEntity, object>> expression,
            ...
            where TEntity : class
        {
            Add<TEntity>(expression, dbType, force: false);
        }
        ...
        public static void Add<TEntity>(string propertyName,
            ...
            where TEntity : class
        {
            Add<TEntity>(propertyName, dbType, force: false);
        }
        ...
        public static void Add<TEntity>(Field field,
            ...
            where TEntity : class
        {
            Add<TEntity>(field, dbType, force: false);
        }
        ...
        internal static void Add<TEntity>(PropertyInfo propertyInfo,
            ...
            where TEntity : class
        {
            Add<TEntity>(propertyInfo, dbType, force: false);
        }
