...
namespace RepoDb
{
    ...
    public static partial class DbConnectionExtension
    {
        ...
        public static TEntity QuerySingle<TEntity>(this IDbConnection connection,
            ...
            where TEntity : class
        {
            return QuerySingleInternal<TEntity>(connection: connection,
                tableName: tableName,
            ...
            where TEntity : class
        {
            ...
            // Return
            return QuerySingleInternalBase<TEntity>(connection: connection,
                tableName: tableName,
                where: where,
                fields: fields,
                orderBy: orderBy,
        ...
        public static async Task<TEntity> QuerySingleAsync<TEntity>(this IDbConnection connection,
            ...
            where TEntity : class
        {
            return await QuerySingleAsyncInternal<TEntity>(connection: connection,
                tableName: tableName,
                fields: fields,
        ...
        public static Task<TEntity> QuerySingleAsync<TEntity>(this IDbConnection connection,
            ...
            where TEntity : class
        {
            return QuerySingleAsyncInternal<TEntity>(connection: connection,
                tableName: tableName,
                fields: fields,
                where: ToQueryGroup(where),
                orderBy: orderBy,
            ...
            where TEntity : class
        {
            ...
            // Return
            return await QuerySingleAsyncInternalBase<TEntity>(connection: connection,
                tableName: tableName,
                fields: fields,
                where: where,
                orderBy: orderBy,
        ...
        public static dynamic QuerySingle<TWhat>(this IDbConnection connection,
            ...
            IStatementBuilder statementBuilder = null)
        {
            return QuerySingle(connection: connection,
                tableName: tableName,
        ...
        public static dynamic QuerySingle(this IDbConnection connection,
            ...
            IStatementBuilder statementBuilder = null)
        {
            return QuerySingleInternal(connection: connection,
                tableName: tableName,
                where: where,
                fields: fields,
                orderBy: orderBy,
        ...
        /// A <see cref="MultipleRowsFoundException"/> is thrown if the query returned more than one row.
        /// </remarks>
        internal static dynamic QuerySingleInternal(this IDbConnection connection,
            string tableName,
            QueryGroup where,
            IEnumerable<Field> fields = null,
            IEnumerable<OrderField> orderBy = null,
            ...
            IStatementBuilder statementBuilder = null)
        {
            return QuerySingleInternal<dynamic>(connection: connection,
                tableName: tableName,
                where: where,
                fields: fields,
                orderBy: orderBy,
        ...
        public static async Task<dynamic> QuerySingleAsync<TWhat>(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return await QuerySingleAsync(connection: connection,
                tableName: tableName,
        ...
        /// A <see cref="MultipleRowsFoundException"/> is thrown if the query returned more than one row.
        /// </remarks>
        public static Task<dynamic> QuerySingleAsync(this IDbConnection connection,
            string tableName,
            QueryField where,
            IEnumerable<Field> fields = null,
            IEnumerable<OrderField> orderBy = null,
            ...
            CancellationToken cancellationToken = default)
        {
            return QuerySingleAsync(connection: connection,
                tableName: tableName,
                where: ToQueryGroup(where),
                fields: fields,
                orderBy: orderBy,
        ...
        public static Task<dynamic> QuerySingleAsync(this IDbConnection connection,
            ...
            CancellationToken cancellationToken = default)
        {
            return QuerySingleAsyncInternal(connection: connection,
                tableName: tableName,
                where: where,
                fields: fields,
                orderBy: orderBy,
        ...
        /// A <see cref="MultipleRowsFoundException"/> is thrown if the query returned more than one row.
        /// </remarks>
        internal static Task<dynamic> QuerySingleAsyncInternal(this IDbConnection connection,
            string tableName,
            QueryGroup where,
            IEnumerable<Field> fields = null,
            IEnumerable<OrderField> orderBy = null,
            ...
            CancellationToken cancellationToken = default)
        {
            return QuerySingleAsyncInternal<dynamic>(connection: connection,
                tableName: tableName,
                where: where,
                fields: fields,
                orderBy: orderBy,
        ...
        #region QuerySingleInternalBase<TEntity>
            ...
            where TEntity : class
        {
            ...
            // Actual Execution
            var result = ExecuteQuerySingleInternal<TEntity>(connection: connection,
        ...
        #region QuerySingleAsyncInternalBase<TEntity>
            ...
            where TEntity : class
        {
            ...
            // Actual Execution
            var result = await ExecuteQuerySingleAsyncInternal<TEntity>(connection: connection,
                commandText: commandText,
                param: param,
                commandType: commandType,
                cacheKey: null,
