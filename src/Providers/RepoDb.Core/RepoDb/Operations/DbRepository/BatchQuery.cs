...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.BatchQuery<TEntity>(tableName: tableName,
                    page: page,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.BatchQuery<TEntity>(page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.BatchQueryAsync<TEntity>(tableName: tableName,
                    page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.BatchQueryAsync(tableName: tableName,
                    page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    where: where,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.BatchQueryAsync<TEntity>(page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Call the method
                return await dbConnection.BatchQueryAsync(page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    where: where,
                    fields: fields,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.BatchQuery(tableName: tableName,
                    page: page,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
