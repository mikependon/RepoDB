...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll(tableName: tableName,
                    entities: entities,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity, TKey>(tableName: tableName,
                    keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity>(tableName: tableName,
                    keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity>(entities: entities,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity, TKey>(keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity>(keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.DeleteAll<TEntity>(hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
                    trace: Trace,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync(tableName: tableName,
                    entities: entities,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync<TEntity, TKey>(tableName: tableName,
                    keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync<TEntity>(tableName: tableName,
                    keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync(entities: entities,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync<TEntity, TKey>(keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync<TEntity>(keys: keys,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.DeleteAllAsync<TEntity>(hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
                    trace: Trace,
