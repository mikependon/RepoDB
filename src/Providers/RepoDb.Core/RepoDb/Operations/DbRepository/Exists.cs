...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Exists<TEntity>(what: what,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Exists<TEntity, TWhat>(what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Exists<TEntity>(where: where,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.ExistsAsync<TEntity>(what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.ExistsAsync<TEntity, TWhat>(what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.ExistsAsync(where: where,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.ExistsAsync<TEntity>(where: where,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.Exists<TWhat>(tableName: tableName,
                    what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.Exists(tableName: tableName,
                    what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.ExistsAsync(tableName: tableName,
                    what: what,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
