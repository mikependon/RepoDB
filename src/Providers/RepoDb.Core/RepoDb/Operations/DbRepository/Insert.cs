...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Insert<TEntity>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Insert<TEntity, TResult>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Insert<TEntity>(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Insert<TEntity, TResult>(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.InsertAsync(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.InsertAsync<TEntity, TResult>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.InsertAsync(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.InsertAsync<TEntity, TResult>(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.Insert(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.Insert<TResult>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.InsertAsync<TResult>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
