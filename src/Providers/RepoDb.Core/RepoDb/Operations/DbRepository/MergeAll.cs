...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.MergeAll<TEntity>(tableName: tableName,
                    entities: entities,
                    batchSize: batchSize,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.MergeAll<TEntity>(entities: entities,
                    batchSize: batchSize,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.MergeAllAsync(tableName: tableName,
                    entities: entities,
                    batchSize: batchSize,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.MergeAllAsync(entities: entities,
                    batchSize: batchSize,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.MergeAll(tableName: tableName,
                    entities: entities,
                    batchSize: batchSize,
                    fields: fields,
                    hints: hints,
