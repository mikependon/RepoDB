...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.MinAll<TEntity>(field: field,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.MinAllAsync<TEntity>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.MinAllAsync(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.MinAll<TEntity, TResult>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.MinAllAsync<TEntity, TResult>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.MinAll(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.MinAllAsync(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.MinAll<TResult>(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.MinAllAsync<TResult>(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
