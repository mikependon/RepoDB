...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.QueryAll<TEntity>(tableName: tableName,
                    fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.QueryAll<TEntity>(fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
                    cacheItemExpiration: CacheItemExpiration,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.QueryAllAsync<TEntity>(tableName: tableName,
                    fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.QueryAllAsync<TEntity>(fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
                    cacheItemExpiration: CacheItemExpiration,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.QueryAll(tableName: tableName,
                    fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.QueryAllAsync(tableName: tableName,
                    fields: fields,
                    orderBy: orderBy,
                    hints: hints,
                    cacheKey: cacheKey,
