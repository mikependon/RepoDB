...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.SkipQuery<TEntity>(tableName: tableName,
                    skip: skip,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.SkipQuery<TEntity>(skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SkipQueryAsync<TEntity>(tableName: tableName,
                    skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SkipQueryAsync(tableName: tableName,
                    skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    where: where,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SkipQueryAsync<TEntity>(skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Call the method
                return await dbConnection.SkipQueryAsync(skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    where: where,
                    fields: fields,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.SkipQuery(tableName: tableName,
                    skip: skip,
                    rowsPerBatch: rowsPerBatch,
                    orderBy: orderBy,
                    fields: fields,
