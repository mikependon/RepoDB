...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.SumAll<TEntity>(field: field,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SumAllAsync<TEntity>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SumAllAsync(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.SumAll<TEntity, TResult>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.SumAllAsync<TEntity, TResult>(field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
                    transaction: transaction,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.SumAll(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.SumAllAsync(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.SumAll<TResult>(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                // Call the method
                return await dbConnection.SumAllAsync<TResult>(tableName: tableName,
                    field: field,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
