...
namespace RepoDb
{
        ...
        where TDbConnection : DbConnection, new()
    {
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Update<TEntity>(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Update<TEntity, TWhat>(tableName: tableName,
                    entity: entity,
                    what: what,
                    fields: fields,
                    hints: hints,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Update<TEntity>(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return dbConnection.Update<TEntity, TWhat>(entity: entity,
                    what: what,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.UpdateAsync(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
            ...
            where TEntity : class
        {
            ...
            {
                // Call the method
                return await dbConnection.UpdateAsync(entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
                    traceKey: traceKey,
            ...
            IDbTransaction transaction = null)
        {
            ...
            {
                // Call the method
                return dbConnection.Update(tableName: tableName,
                    entity: entity,
                    fields: fields,
                    hints: hints,
                    commandTimeout: CommandTimeout,
