...
{
    /// <summary>
    /// A property handler that maps an unsigned 128-bit integer column (for example, the ClickHouse <c>UInt128</c> type, which drivers expose as a <see cref="BigInteger"/>) into a <see cref="Nullable{T}"/> of <see cref="UInt128"/> property.
    /// </summary>
    public class BigIntegerToNullableUInt128PropertyHandler : IPropertyHandler<object, UInt128?>
    {
        /// <summary>
        /// Converts the unsigned 128-bit integer value, as returned by the driver, into a <see cref="Nullable{T}"/> of <see cref="UInt128"/>.
        /// </summary>
        ...
        /// <returns>The <see cref="UInt128"/>, or <c>null</c> when the value is <c>null</c>.</returns>
        ...
        public UInt128? Get(object input,
            ...
            UInt128Converter.ToUInt128(input);
