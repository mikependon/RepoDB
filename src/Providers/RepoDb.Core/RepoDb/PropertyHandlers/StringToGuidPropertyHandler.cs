...
{
    /// <summary>
    /// A property handler that maps a text-based UUID column (for example, the MariaDB <c>UUID</c> type) into a <see cref="Guid"/> property.
    /// </summary>
    /// <remarks>
    /// Use <see cref="StringToNullableGuidPropertyHandler"/> for a <see cref="Nullable{T}"/> of <see cref="Guid"/> property.
    /// </remarks>
    public class StringToGuidPropertyHandler : IPropertyHandler<object, Guid>
    {
        /// <summary>
        /// Converts the UUID value, as returned by the driver, into a <see cref="Guid"/>.
        /// </summary>
        ...
        /// <returns>The <see cref="Guid"/>, or <see cref="Guid.Empty"/> when the value is <c>null</c> or empty.</returns>
        public Guid Get(object input,
            PropertyHandlerGetOptions options) =>
            GuidConverter.ToGuid(input) ?? Guid.Empty;
        ...
        /// <returns>The canonical text of the <see cref="Guid"/> (as a <see cref="string"/>).</returns>
