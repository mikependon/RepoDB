...
namespace RepoDb.Enumerations.Db2
{
    /// <summary>
    /// Specifies what kind of staging table backs a <c>BulkMerge</c>, <c>BulkUpdate</c>, or <c>BulkDelete</c>
    /// operation against MySQL via Db2.
    /// </summary>
    public enum Db2BulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="Db2Constants.RowCountThresholdForPhysicalTable"/>, otherwise selects
