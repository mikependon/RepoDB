...
namespace RepoDb.Db2.IntegrationTests
{
    public static class Helper
    {
        ...
        /// Only the scalar columns are compared - a dynamic row carries the raw IBM Data Server driver values (FOR BIT DATA
        /// binaries, GRAPHIC strings, fixed-width CHAR padding), which are already covered by the typed
        /// <see cref="AssertPropertiesEquality{T}(T, T)"/>.
        /// </summary>
