...
namespace RepoDb.Db2.UnitTests.Resolvers
{
    ...
    public class DbTypeToDb2StringNameResolverTest
    {
        ...
        {
            Assert.AreEqual("BIGINT", m_resolver.Resolve(DbType.Int64), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForInt32()
        {
            Assert.AreEqual("INTEGER", m_resolver.Resolve(DbType.Int32), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForInt16()
        {
            Assert.AreEqual("SMALLINT", m_resolver.Resolve(DbType.Int16), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForByte()
        {
            Assert.AreEqual("SMALLINT", m_resolver.Resolve(DbType.Byte), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForBoolean()
        {
            Assert.AreEqual("SMALLINT", m_resolver.Resolve(DbType.Boolean), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForString()
        {
            Assert.AreEqual("VARCHAR(2000)", m_resolver.Resolve(DbType.String), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForAnsiString()
        {
            Assert.AreEqual("VARCHAR(2000)", m_resolver.Resolve(DbType.AnsiString), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForDateTime()
        {
            ...
            Assert.AreEqual("TIMESTAMP", m_resolver.Resolve(DbType.DateTime), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForDateTimeOffset()
        {
            ...
            Assert.AreEqual("TIMESTAMP", m_resolver.Resolve(DbType.DateTimeOffset), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForDecimal()
        {
            Assert.AreEqual("DECIMAL(31,15)", m_resolver.Resolve(DbType.Decimal), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForDouble()
        {
            Assert.AreEqual("DOUBLE", m_resolver.Resolve(DbType.Double), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForSingle()
        {
            Assert.AreEqual("REAL", m_resolver.Resolve(DbType.Single), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForGuid()
        {
            ...
            Assert.AreEqual("CHAR(16) FOR BIT DATA", m_resolver.Resolve(DbType.Guid), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForBinary()
        {
            Assert.AreEqual("BLOB(1M)", m_resolver.Resolve(DbType.Binary), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForXml()
        {
            Assert.AreEqual("XML", m_resolver.Resolve(DbType.Xml), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForAnsiStringFixedLength()
        {
            ...
            Assert.AreEqual("CHAR(254)", m_resolver.Resolve(DbType.AnsiStringFixedLength), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForStringFixedLength()
        {
            ...
            Assert.AreEqual("GRAPHIC(127)", m_resolver.Resolve(DbType.StringFixedLength), StringComparer.Ordinal);
        }

        [TestMethod]
        public void TestDbTypeToDb2StringNameResolverForObject()
        {
            Assert.AreEqual("BLOB(1M)", m_resolver.Resolve(DbType.Object), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverForTime()
        {
            ...
            // provides one.
            Assert.AreEqual("TIME", m_resolver.Resolve(DbType.Time), StringComparer.Ordinal);
        }
        ...
        public void TestDbTypeToDb2StringNameResolverFallsBackToVarcharForUnmappedDbTypes()
        {
            ...
            Assert.AreEqual("VARCHAR(2000)", m_resolver.Resolve(DbType.Currency), StringComparer.Ordinal);
        }
    }
}
