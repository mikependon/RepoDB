...
namespace RepoDb.DuckDb.BulkOperations.IntegrationTests
{
    /// <summary>
    ...
    public static class Helper
    {
        static Helper()
        {
            StatementBuilder = StatementBuilderMapper.Get<DuckDBConnection>();
        ...
        /// <summary>
        /// Returns the current UTC time truncated to the microsecond precision of a DuckDB <c>TIMESTAMP</c>.
        /// </summary>
