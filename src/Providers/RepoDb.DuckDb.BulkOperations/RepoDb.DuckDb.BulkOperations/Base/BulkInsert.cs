...
namespace RepoDb
{
    public static partial class DuckDbConnectionExtension
    {
        ...
        {
            var entityList = entities.AsList();
            var pseudoTableName = DuckDbText.GetPseudoTableNameForInsert(tableName, pseudoTableType, connection.GetDbSetting());
            ...
            try
            {
                ...
                result = DuckDbExecution.InsertFromPseudoTableForReturnIdentity(connection, tableName, pseudoTableName, insertFields, identityField, entityList, trace, traceKey, transaction);
            }
            finally
            {
        ...
        private static int BulkInsertBase(this DuckDBConnection connection,
            string tableName,
            DataTable table,
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseForReturnIdentity(this DuckDBConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            ...
            DuckDBTransaction transaction = null)
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings, identityField);
                result = DuckDbExecution.InsertFromPseudoTableForReturnIdentityForDataTable(connection, tableName, pseudoTableName, insertFields, identityField, rows, trace, traceKey, transaction);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseNoReturnIdentity(this DuckDBConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings, identityField);
                result = await DuckDbExecution.InsertFromPseudoTableForReturnIdentityAsync(connection, tableName, pseudoTableName, insertFields, identityField, entityList, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        private static async Task<int> BulkInsertBaseAsync(this DuckDBConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseForReturnIdentityAsync(this DuckDBConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings, identityField);
                result = await DuckDbExecution.InsertFromPseudoTableForReturnIdentityForDataTableAsync(connection, tableName, pseudoTableName, insertFields, identityField, rows, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseNoReturnIdentityAsync(this DuckDBConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
