...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the DuckDB bulk-delete
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkDelete<TEntity>(this BaseRepository<TEntity, DuckDBConnection> repository,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteAsync<TEntity>(this BaseRepository<TEntity, DuckDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
