...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the DuckDB bulk-merge
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkMerge<TEntity>(this BaseRepository<TEntity, DuckDBConnection> repository,
        ...
        /// <returns>The number of affected rows.</returns>
        public static Task<int> BulkMergeAsync<TEntity>(this BaseRepository<TEntity, DuckDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
