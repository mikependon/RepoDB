...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the DuckDB bulk-insert operation. Each method
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this DbRepository<DuckDBConnection> repository,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static async Task<int> BulkInsertAsync<TEntity>(this DbRepository<DuckDBConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
