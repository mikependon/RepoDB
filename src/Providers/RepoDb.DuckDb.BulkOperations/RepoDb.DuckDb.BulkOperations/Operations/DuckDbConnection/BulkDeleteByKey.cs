...
namespace RepoDb
{
    public static partial class DuckDbConnectionExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this DuckDBConnection connection,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this DuckDBConnection connection,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
