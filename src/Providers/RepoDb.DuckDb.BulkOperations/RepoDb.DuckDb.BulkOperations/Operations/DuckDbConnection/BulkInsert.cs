...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for DuckDb, exposed as <see cref="DuckDBConnection"/>
    ...
    public static partial class DuckDbConnectionExtension
    {
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this DuckDBConnection connection,
            DataTable table,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this DuckDBConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<DuckDbBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
