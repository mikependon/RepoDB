...
namespace RepoDb.DuckDb.IntegrationTests.Operations
{
    ...
    public class ExecuteQueryTest
    {
        ...
        [TestMethod]
        public void TestDuckDBConnectionExecuteQuery()
        {
            // Setup
        ...
        [TestMethod]
        public void TestDuckDBConnectionExecuteQueryWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionExecuteQueryAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionExecuteQueryAsyncWithParameters()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
