...
namespace RepoDb.DuckDb.IntegrationTests.Operations
{
    ...
    public class QueryAllTest
    {
        ...
        [TestMethod]
        public void TestDuckDBConnectionQueryAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestDuckDBConnectionQueryAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestDuckDBConnectionQueryAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionQueryAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
