...
namespace RepoDb.DuckDb.IntegrationTests.Operations
{
    ...
    public class UpdateAllTest
    {
        ...
        [TestMethod]
        public void TestDuckDBConnectionUpdateAll()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionUpdateAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestDuckDBConnectionUpdateAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestDuckDBConnectionUpdateAllViaTableNameAsExpandoObjects()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionUpdateAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestDuckDBConnectionUpdateAllAsyncViaTableNameAsExpandoObjects()
        {
            // Setup
            var entities = Database.CreateCompleteTables(10).AsList();
