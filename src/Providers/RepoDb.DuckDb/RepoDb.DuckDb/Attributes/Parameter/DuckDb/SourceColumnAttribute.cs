...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="DuckDBParameter.SourceColumn"/>
    ...
    public class SourceColumnAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnAttribute(string sourceColumn)
            : base(typeof(DuckDBParameter), nameof(DuckDBParameter.SourceColumn), sourceColumn)
        { }
