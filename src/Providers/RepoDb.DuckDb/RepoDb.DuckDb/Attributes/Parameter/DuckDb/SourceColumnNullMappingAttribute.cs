...
namespace RepoDb.Attributes.Parameter.DuckDb
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="DuckDBParameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(DuckDBParameter), nameof(DuckDBParameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
