...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="DuckDBParameter.SourceVersion"/>
    ...
    public class SourceVersionAttribute : PropertyValueAttribute
    {
        ...
        public SourceVersionAttribute(DataRowVersion sourceVersion)
            : base(typeof(DuckDBParameter), nameof(DuckDBParameter.SourceVersion), sourceVersion)
        { }
