...
namespace RepoDb.EnterpriseDb.BulkOperations.IntegrationTests
{
    /// <summary>
    ...
    public static class Helper
    {
        static Helper()
        {
            StatementBuilder = StatementBuilderMapper.Get<EDBConnection>();
        ...
        /// precision a Postgres/EDB <c>TIMESTAMP(6)</c> column (used for <c>ColumnDateTime2</c>/
        ...
        /// Postgres/EDB on write, and a direct <see cref="DateTime"/> equality assertion between the
