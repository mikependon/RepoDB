...
{
    [TestClass]
    public class EDBConnectionBulkDeleteByKeyOperationsTest
    {
        [TestInitialize]
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKey()
        {
            // Setup
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKeyWithBatchSize()
        {
            // Setup
            var tables = Helper.CreateBulkOperationIdentityTables(10);
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKeyViaPhysicalTable()
        {
            // Setup
            var tables = Helper.CreateBulkOperationIdentityTables(10);
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKeyAsync()
        {
            // Setup
            var tables = Helper.CreateBulkOperationIdentityTables(10);
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKeyAsyncWithBatchSize()
        {
            // Setup
            var tables = Helper.CreateBulkOperationIdentityTables(10);
        ...
        [TestMethod]
        public void TestEDBConnectionBulkDeleteByKeyAsyncViaPhysicalTable()
        {
            // Setup
            var tables = Helper.CreateBulkOperationIdentityTables(10);
