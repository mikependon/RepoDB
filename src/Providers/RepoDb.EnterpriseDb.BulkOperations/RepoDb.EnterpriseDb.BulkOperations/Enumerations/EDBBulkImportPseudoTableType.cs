...
namespace RepoDb.Enumerations.EnterpriseDb
{
    /// <summary>
    /// Specifies what kind of staging table backs a <c>BulkMerge</c>, <c>BulkUpdate</c>, or <c>BulkDelete</c>
    /// operation against EnterpriseDB.
    /// </summary>
    public enum EDBBulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="EDBConstants.RowCountThresholdForPhysicalTable"/>, otherwise selects
