...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrappers for the EnterpriseDB bulk-update
    /// operation.
    /// </summary>
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkUpdate<TEntity>(this BaseRepository<TEntity, EDBConnection> repository,
        ...
        /// <returns>The number of updated rows.</returns>
        public static Task<int> BulkUpdateAsync<TEntity>(this BaseRepository<TEntity, EDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
