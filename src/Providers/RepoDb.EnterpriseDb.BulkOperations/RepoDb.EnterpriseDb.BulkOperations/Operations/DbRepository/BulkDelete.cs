...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the EnterpriseDB bulk-delete operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkDelete<TEntity>(this DbRepository<EDBConnection> repository,
        ...
        public static int BulkDelete<TEntity>(this DbRepository<EDBConnection> repository,
            ...
            where TEntity : class
        {
            var connection = (EDBConnection)transaction?.Connection ?? repository.CreateConnection();
        ...
        /// <returns>The number of deleted rows.</returns>
        public static async Task<int> BulkDeleteAsync<TEntity>(this DbRepository<EDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        private static void DisposeIfOwned(DbRepository<EDBConnection> repository,
