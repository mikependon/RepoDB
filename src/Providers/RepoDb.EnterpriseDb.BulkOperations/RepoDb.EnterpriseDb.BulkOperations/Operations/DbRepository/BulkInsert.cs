...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the EnterpriseDB bulk-insert operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this DbRepository<EDBConnection> repository,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static async Task<int> BulkInsertAsync<TEntity>(this DbRepository<EDBConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
