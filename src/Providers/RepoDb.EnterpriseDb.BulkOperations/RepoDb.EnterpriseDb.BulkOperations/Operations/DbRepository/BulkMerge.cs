...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the EnterpriseDB bulk-merge operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkMerge<TEntity>(this DbRepository<EDBConnection> repository,
        ...
        /// <returns>The number of affected rows.</returns>
        public static async Task<int> BulkMergeAsync<TEntity>(this DbRepository<EDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
