...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the EnterpriseDB bulk-update operation.
    /// </summary>
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkUpdate<TEntity>(this DbRepository<EDBConnection> repository,
        ...
        /// <returns>The number of updated rows.</returns>
        public static async Task<int> BulkUpdateAsync<TEntity>(this DbRepository<EDBConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
