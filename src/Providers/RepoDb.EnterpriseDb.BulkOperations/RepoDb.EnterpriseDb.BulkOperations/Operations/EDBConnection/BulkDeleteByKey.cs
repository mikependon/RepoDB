...
namespace RepoDb
{
    public static partial class EDBConnectionExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this EDBConnection connection,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this EDBConnection connection,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
