...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for EnterpriseDB, exposed as <see cref="EDBConnection"/>
    ...
    public static partial class EDBConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this EDBConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this EDBConnection connection,
            DataTable table,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this EDBConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this EDBConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<EDBBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
