...
namespace RepoDb.EnterpriseDb.IntegrationTests.Operations
{
    ...
    public class TruncateTest
    {
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionTruncate()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionTruncateAsyncWithoutExpression()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestEnterpriseDbConnectionTruncateViaTableNameWithoutExpression()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestEnterpriseDbConnectionTruncateAsyncViaTableNameWithoutExpression()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
