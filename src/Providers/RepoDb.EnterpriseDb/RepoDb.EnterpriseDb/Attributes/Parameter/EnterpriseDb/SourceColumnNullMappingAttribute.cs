...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="EDBParameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(EDBParameter), nameof(EDBParameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
