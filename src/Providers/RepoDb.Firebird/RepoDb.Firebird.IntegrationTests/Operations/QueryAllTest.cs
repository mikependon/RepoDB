...
namespace RepoDb.Firebird.IntegrationTests.Operations
{
    ...
    public class QueryAllTest
    {
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestFirebirdConnectionQueryAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestFirebirdConnectionQueryAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
