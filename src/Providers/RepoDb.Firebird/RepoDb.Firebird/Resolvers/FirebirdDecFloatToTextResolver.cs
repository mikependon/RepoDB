...
namespace RepoDb.Resolvers
{
    ...
    /// (an <see cref="FbDecFloat"/>, a <see cref="decimal"/> or a <see cref="string"/>), into its text form.
    /// </summary>
    public class FirebirdDecFloatToTextResolver : IResolver<object, string>
    {
        /// <summary>
        ...
        public virtual string Resolve(object value)
        {
            switch (value)
            {
                case null:
