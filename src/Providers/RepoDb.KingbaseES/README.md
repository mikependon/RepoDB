...
KingbaseES is on the [databases roadmap](https://github.com/mikependon/RepoDB#databases-on-the-roadmap) — a dedicated `RepoDb.KingbaseES` package is not yet available.
