...
namespace RepoDb
{
    ...
    public static partial class MariaDbConnectionExtension
    {
            ...
            where TEntity : class
        {
            ...
            var pseudoTableName = MariaDbText.GetPseudoTableNameForUpdate(tableName, pseudoTableType, connection.GetDbSetting());
            ...
            try
            {
                ...
                // Execute and return
                result = MariaDbExecution.UpdateFromPseudoTable(connection, tableName, pseudoTableName, stagingFields, qualifierFields, trace, traceKey, transaction);
            }
            finally
            {
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Execute and return
                result = await MariaDbExecution.UpdateFromPseudoTableAsync(connection, tableName, pseudoTableName, stagingFields, qualifierFields, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
