...
namespace RepoDb.PropertyHandlers.MariaDbConnector
{
    ...
    /// </summary>
    public class MariaDbConnectorGeometryToMySqlGeometryPropertyHandler : IPropertyHandler<object, MySqlGeometry>
    {
        /// <summary>
        ...
        /// <summary>
        /// Converts the <see cref="MySqlGeometry"/> into the value written into the spatial column, which the driver serializes as its MySQL/MariaDB internal format.
        /// </summary>
