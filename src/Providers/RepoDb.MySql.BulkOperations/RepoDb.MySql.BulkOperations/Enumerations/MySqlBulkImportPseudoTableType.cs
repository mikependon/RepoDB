...
namespace RepoDb.Enumerations.MySql
{
    /// <summary>
    /// Specifies what kind of staging table backs a <c>BulkMerge</c>, <c>BulkUpdate</c>, or <c>BulkDelete</c>
    /// operation against MySQL via MySql.
    /// </summary>
    public enum MySqlBulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="MySqlConstants.RowCountThresholdForPhysicalTable"/>, otherwise selects
