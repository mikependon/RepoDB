...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="MySqlParameter.SourceVersion"/>
    ...
    public class SourceVersionAttribute : PropertyValueAttribute
    {
        ...
        public SourceVersionAttribute(DataRowVersion sourceVersion)
            : base(typeof(MySqlParameter), nameof(MySqlParameter.SourceVersion), sourceVersion)
        { }
