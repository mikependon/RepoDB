...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="MySqlParameter.SourceColumn"/>
    ...
    public class SourceColumnAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnAttribute(string sourceColumn)
            : base(typeof(MySqlParameter), nameof(MySqlParameter.SourceColumn), sourceColumn)
        { }
