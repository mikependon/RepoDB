...
namespace RepoDb.Oracle.IntegrationTests
{
    ...
    public class EnumTests
    {
        ...
        public void Initialize()
        {
            ...
            PropertyHandlerMapper.Add<PersonWithText, OracleGuidToByteArrayPropertyHandler>(
                e => e.SessionId, new OracleGuidToByteArrayPropertyHandler(), true);
            PropertyHandlerMapper.Add<PersonWithInteger, OracleGuidToByteArrayPropertyHandler>(
                e => e.SessionId, new OracleGuidToByteArrayPropertyHandler(), true);
            PropertyHandlerMapper.Add<PersonWithTextAsInteger, OracleGuidToByteArrayPropertyHandler>(
                e => e.SessionId, new OracleGuidToByteArrayPropertyHandler(), true);
        }
        ...
        public class PersonWithTextAsInteger
        {
            ...
            // though the target column ("ColumnVarchar") is textual. Oracle implicitly converts a bound
