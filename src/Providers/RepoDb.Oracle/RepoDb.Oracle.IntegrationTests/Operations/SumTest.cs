    ...
    public class SumTest
    {
        ...
        public void TestOracleConnectionSumViaExpression()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(e => ids.Contains(e.Id)).Sum(e => e.ColumnSmallInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public void TestOracleConnectionSumViaDynamic()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(e => e.Id == tables.First().Id).Sum(e => e.ColumnSmallInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
        ...
        public void TestOracleConnectionSumViaQueryFields()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual(tables.Where(e => e.Id > tables.First().Id && e.Id < tables.Last().Id).Sum(e => e.ColumnSmallInt), Convert.ToInt32(result, System.Globalization.CultureInfo.InvariantCulture));
            }
        }
