...
namespace RepoDb
{
    ...
    public static partial class BaseRepositoryExtension
    {
        ...
        public static async Task<int> BulkUpdateAsync<TEntity>(this BaseRepository<TEntity, NpgsqlConnection> repository,
            ...
            where TEntity : class =>
            await repository.DbRepository.BulkUpdateAsync<TEntity>(tableName: ClassMappedNameCache.Get<TEntity>(),
                    entities: entities,
                    qualifiers: qualifiers,
                    mappings: mappings,
                    bulkCopyTimeout: bulkCopyTimeout,
        ...
        public static async Task<int> BulkUpdateAsync<TEntity>(this BaseRepository<TEntity, NpgsqlConnection> repository,
            ...
            CancellationToken cancellationToken = default)
            where TEntity : class =>
            await repository.DbRepository.BulkUpdateAsync<TEntity>(tableName: (tableName ?? ClassMappedNameCache.Get<TEntity>()),
                    entities: entities,
                    qualifiers: qualifiers,
                    mappings: mappings,
                    bulkCopyTimeout: bulkCopyTimeout,
