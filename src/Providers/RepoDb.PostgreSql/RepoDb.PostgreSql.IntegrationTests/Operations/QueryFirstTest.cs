...
namespace RepoDb.PostgreSql.IntegrationTests.Operations
{
    ...
    public class QueryFirstTest
    {
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaPrimaryKey()
        {
            // Setup
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaExpression()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstWithOrderBy()
        {
            // Setup
        ...
        [TestMethod]
        public void ThrowExceptionOnTestPostgreSqlConnectionQueryFirstIfNoRowsFound()
        {
            using (var connection = new NpgsqlConnection(Database.ConnectionString))
            {
                // Act
        ...
        [TestMethod]
        public void ThrowExceptionOnTestPostgreSqlConnectionQueryFirstIfNoRowsMatchTheFilter()
        {
            // Setup
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaPrimaryKey()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaExpression()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncWithOrderBy()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task ThrowExceptionOnTestPostgreSqlConnectionQueryFirstAsyncIfNoRowsFound()
        {
            using (var connection = new NpgsqlConnection(Database.ConnectionString))
            {
                // Act
        ...
        [TestMethod]
        public async Task ThrowExceptionOnTestPostgreSqlConnectionQueryFirstAsyncIfNoRowsMatchTheFilter()
        {
            // Setup
            Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameViaPrimaryKey()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public void TestPostgreSqlConnectionQueryFirstViaTableNameWithOrderBy()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public void ThrowExceptionOnTestPostgreSqlConnectionQueryFirstViaTableNameIfNoRowsFound()
        {
            using (var connection = new NpgsqlConnection(Database.ConnectionString))
            {
                // Act
        ...
        [TestMethod]
        public void ThrowExceptionOnTestPostgreSqlConnectionQueryFirstViaTableNameIfNoRowsMatchTheFilter()
        {
            // Setup
            Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameViaPrimaryKey()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameViaDynamic()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameViaQueryField()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameViaQueryFields()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameViaQueryGroup()
        {
            // Setup
            var table = Database.CreateCompleteTables(10).Last();
            var queryFields = new[]
        ...
        [TestMethod]
        public async Task TestPostgreSqlConnectionQueryFirstAsyncViaTableNameWithOrderBy()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10).ToList();
        ...
        [TestMethod]
        public async Task ThrowExceptionOnTestPostgreSqlConnectionQueryFirstAsyncViaTableNameIfNoRowsFound()
        {
            using (var connection = new NpgsqlConnection(Database.ConnectionString))
            {
                // Act
        ...
        [TestMethod]
        public async Task ThrowExceptionOnTestPostgreSqlConnectionQueryFirstAsyncViaTableNameIfNoRowsMatchTheFilter()
        {
            // Setup
            Database.CreateCompleteTables(10);
