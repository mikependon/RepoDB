    ...
    public static partial class SapHanaConnectionExtension
    {
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Execute and return
                result = await SapHanaExecution.DeleteFromPseudoTableAsync(connection, tableName, pseudoTableName, qualifierFields, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
