...
namespace RepoDb
{
    ...
    public static partial class SapHanaConnectionExtension
    {
        ...
        /// <returns></returns>
        private static int BulkInsertBase<TEntity>(this HanaConnection connection,
            string tableName,
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseForReturnIdentity<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        {
            var entityList = entities.AsList();
            var pseudoTableName = SapHanaText.GetPseudoTableNameForInsert(tableName, pseudoTableType, connection.GetDbSetting());
            ...
            try
            {
                ...
                result = SapHanaExecution.InsertFromPseudoTableForReturnIdentity(connection, tableName, pseudoTableName, insertFields, identityField, entityList, trace, traceKey, transaction);
            }
            finally
            {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseNoReturnIdentity<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBase(this HanaConnection connection,
            string tableName,
            DataTable table,
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseForReturnIdentity(this HanaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            ...
            HanaTransaction transaction = null)
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings);
                result = SapHanaExecution.InsertFromPseudoTableForReturnIdentityForDataTable(connection, tableName, pseudoTableName, insertFields, identityField, rows, trace, traceKey, transaction);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkInsertBaseNoReturnIdentity(this HanaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
        ...
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseAsync<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseForReturnIdentityAsync<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings);
                result = await SapHanaExecution.InsertFromPseudoTableForReturnIdentityAsync(connection, tableName, pseudoTableName, insertFields, identityField, entityList, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseNoReturnIdentityAsync<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseAsync(this HanaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseForReturnIdentityAsync(this HanaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                // Execute and return
                var insertFields = GetInsertFields(tableName, dbFields, mappings);
                result = await SapHanaExecution.InsertFromPseudoTableForReturnIdentityForDataTableAsync(connection, tableName, pseudoTableName, insertFields, identityField, rows, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkInsertBaseNoReturnIdentityAsync(this HanaConnection connection,
            string tableName,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
