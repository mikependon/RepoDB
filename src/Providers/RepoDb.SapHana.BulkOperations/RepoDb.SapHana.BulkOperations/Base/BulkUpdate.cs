...
namespace RepoDb
{
    ...
    public static partial class SapHanaConnectionExtension
    {
        ...
        /// <returns></returns>
        private static int BulkUpdateBase<TEntity>(this HanaConnection connection,
            string tableName,
            ...
            where TEntity : class
        {
            ...
            var pseudoTableName = SapHanaText.GetPseudoTableNameForUpdate(tableName, pseudoTableType, connection.GetDbSetting());
            ...
            try
            {
                ...
                // Execute and return
                result = SapHanaExecution.UpdateFromPseudoTable(connection, tableName, pseudoTableName, stagingFields, qualifierFields, trace, traceKey, transaction);
            }
            finally
            {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        private static int BulkUpdateBase(this HanaConnection connection,
            string tableName,
            DataTable table,
            IEnumerable<Field> qualifiers = null,
        ...
        /// <returns></returns>
        private static async Task<int> BulkUpdateBaseAsync<TEntity>(this HanaConnection connection,
            string tableName,
            IEnumerable<TEntity> entities,
            IEnumerable<Field> qualifiers = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                // Execute and return
                result = await SapHanaExecution.UpdateFromPseudoTableAsync(connection, tableName, pseudoTableName, stagingFields, qualifierFields, trace, traceKey, transaction, cancellationToken).ConfigureAwait(false);
            }
            finally
            {
                // Drop the pseudo table
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        private static async Task<int> BulkUpdateBaseAsync(this HanaConnection connection,
            string tableName,
            DataTable table,
            IEnumerable<Field> qualifiers = null,
            DataRowState? rowState = null,
