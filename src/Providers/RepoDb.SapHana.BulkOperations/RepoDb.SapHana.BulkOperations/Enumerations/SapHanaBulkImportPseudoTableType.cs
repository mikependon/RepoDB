...
namespace RepoDb.Enumerations.SapHana
{
    ...
    /// operation against SAP HANA.
    /// </summary>
    public enum SapHanaBulkImportPseudoTableType : short
    {
        /// <summary>
        /// Automatically selects <see cref="Physical"/> when the entity/row count being bulk-written is at
        /// least <see cref="SapHanaConstants.RowCountThresholdForPhysicalTable"/>, otherwise selects
