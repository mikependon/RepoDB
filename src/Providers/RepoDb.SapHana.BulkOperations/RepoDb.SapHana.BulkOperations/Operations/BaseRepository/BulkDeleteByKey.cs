...
{
    /// <summary>
    /// Entity-typed <see cref="BaseRepository{TEntity, TDbConnection}"/> wrapper for the SapHana
    ...
    /// <see cref="HanaConnection"/> extension method - matching the three-tier pattern used throughout
    /// the rest of RepoDB.
    /// </summary>
    public static partial class BaseRepositoryExtension
    {
        ...
        public static int BulkDeleteByKey<TEntity, TPrimaryKey>(this BaseRepository<TEntity, HanaConnection> repository,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TEntity, TPrimaryKey>(this BaseRepository<TEntity, HanaConnection> repository,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
