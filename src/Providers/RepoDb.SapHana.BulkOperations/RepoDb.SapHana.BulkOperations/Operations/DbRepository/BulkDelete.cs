...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the SapHana bulk-delete operation. Each method
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkDelete<TEntity>(this DbRepository<HanaConnection> repository,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static async Task<int> BulkDeleteAsync<TEntity>(this DbRepository<HanaConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        private static void DisposeIfOwned(DbRepository<HanaConnection> repository,
