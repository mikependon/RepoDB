...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the SapHana bulk-insert operation. Each method
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkInsert<TEntity>(this DbRepository<HanaConnection> repository,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static async Task<int> BulkInsertAsync<TEntity>(this DbRepository<HanaConnection> repository,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
