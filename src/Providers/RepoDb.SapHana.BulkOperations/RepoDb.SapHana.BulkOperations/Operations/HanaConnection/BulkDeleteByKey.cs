...
namespace RepoDb
{
    public static partial class SapHanaConnectionExtension
    {
        ...
        public static int BulkDeleteByKey<TPrimaryKey>(this HanaConnection connection,
            string tableName,
        ...
        /// <returns>The number of deleted rows.</returns>
        public static Task<int> BulkDeleteByKeyAsync<TPrimaryKey>(this HanaConnection connection,
            string tableName,
            IEnumerable<TPrimaryKey> primaryKeys,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
