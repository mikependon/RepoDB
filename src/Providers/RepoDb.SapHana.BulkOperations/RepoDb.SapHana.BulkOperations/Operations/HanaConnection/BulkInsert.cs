...
{
    /// <summary>
    /// Contains the official bulk operations of RepoDB for SapHana, exposed as <see cref="HanaConnection"/>
    ...
    public static partial class SapHanaConnectionExtension
    {
        ...
        public static int BulkInsert<TEntity>(this HanaConnection connection,
        ...
        /// <param name="transaction">The transaction to be used.</param>
        /// <returns>The number of inserted rows.</returns>
        public static int BulkInsert(this HanaConnection connection,
            DataTable table,
        ...
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync<TEntity>(this HanaConnection connection,
            IEnumerable<TEntity> entities,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
            int? batchSize = null,
        ...
        /// <param name="cancellationToken">The token to cancel the asynchronous operation.</param>
        /// <returns>The number of inserted rows.</returns>
        public static Task<int> BulkInsertAsync(this HanaConnection connection,
            DataTable table,
            DataRowState? rowState = null,
            IEnumerable<SapHanaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
