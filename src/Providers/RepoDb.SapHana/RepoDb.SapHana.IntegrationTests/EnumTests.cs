...
namespace RepoDb.SapHana.IntegrationTests
{
    ...
    public class EnumTests
    {
        ...
        [TestMethod]
        [Ignore("Unlike SQL Server/MySQL, HANA's ADO.NET client rejects sending an INT-typed parameter " +
            "into an NCLOB column outright ('Conversion not supported for parameter/column, source type " +
            "INT4 and target type NCLOB') rather than implicitly coercing it - there's no client-side fix " +
            "for this since the driver itself refuses the bind.")]
        ...
        [TestMethod]
        [Ignore("See the remark on TestInsertAndQueryEnumAsTextAsInt.")]
