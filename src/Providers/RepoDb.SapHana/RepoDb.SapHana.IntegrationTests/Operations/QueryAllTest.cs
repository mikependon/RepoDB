...
namespace RepoDb.SapHana.IntegrationTests.Operations
{
    ...
    public class QueryAllTest
    {
        ...
        [TestMethod]
        public void TestHanaConnectionQueryAll()
        {
            // Setup
        ...
        [TestMethod]
        public void TestHanaConnectionQueryAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestHanaConnectionQueryAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestHanaConnectionQueryAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
