...
namespace RepoDb.SapHana.IntegrationTests.Operations
{
    ...
    public class SumAllTest
    {
        ...
        [TestMethod]
        public void TestHanaConnectionSumAll()
        {
            // Setup
        ...
        [TestMethod]
        public void ThrowExceptionOnHanaConnectionSumAllWithHints()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestHanaConnectionSumAllAsync()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task ThrowExceptionOnHanaConnectionSumAllAsyncWithHints()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void TestHanaConnectionSumAllViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public void ThrowExceptionOnHanaConnectionSumAllViaTableNameWithHints()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task TestHanaConnectionSumAllAsyncViaTableName()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
        ...
        [TestMethod]
        public async Task ThrowExceptionOnHanaConnectionSumAllAsyncViaTableNameWithHints()
        {
            // Setup
            var tables = Database.CreateCompleteTables(10);
