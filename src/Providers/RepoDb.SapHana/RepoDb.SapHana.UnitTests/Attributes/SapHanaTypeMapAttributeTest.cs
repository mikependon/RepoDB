...
namespace RepoDb.SapHana.UnitTests.Attributes
{
    [TestClass]
    public class SapHanaTypeMapAttributeTest
    {
        [TestInitialize]
        ...
        [TestMethod]
        public void TestSapHanaTypeMapAttributeViaEntityViaCreateParameters()
        {
            // Act
        ...
        [TestMethod]
        public void TestSapHanaTypeMapAttributeViaAnonymousViaCreateParameters()
        {
            // Act
            using (var connection = new HanaConnection())
            {
