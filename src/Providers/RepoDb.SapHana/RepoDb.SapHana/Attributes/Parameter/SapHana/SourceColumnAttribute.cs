...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="HanaParameter.SourceColumn"/>
    ...
    public class SourceColumnAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnAttribute(string sourceColumn)
            : base(typeof(HanaParameter), nameof(HanaParameter.SourceColumn), sourceColumn)
        { }
