...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="HanaParameter.SourceColumnNullMapping"/>
    ...
    public class SourceColumnNullMappingAttribute : PropertyValueAttribute
    {
        ...
        public SourceColumnNullMappingAttribute(bool sourceColumnNullMapping)
            : base(typeof(HanaParameter), nameof(HanaParameter.SourceColumnNullMapping), sourceColumnNullMapping)
        { }
