...
{
    /// <summary>
    /// An attribute used to define a value to the <see cref="HanaParameter.SourceVersion"/>
    ...
    public class SourceVersionAttribute : PropertyValueAttribute
    {
        ...
        public SourceVersionAttribute(DataRowVersion sourceVersion)
            : base(typeof(HanaParameter), nameof(HanaParameter.SourceVersion), sourceVersion)
        { }
