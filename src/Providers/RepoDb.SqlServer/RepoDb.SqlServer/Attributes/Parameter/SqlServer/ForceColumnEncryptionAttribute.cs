...
namespace RepoDb.Attributes.Parameter.SqlServer
{
    ...
    public class ForceColumnEncryptionAttribute(bool forceColumnEncryption) : PropertyValueAttribute(typeof(SqlParameter), nameof(SqlParameter.ForceColumnEncryption), forceColumnEncryption)
    {
