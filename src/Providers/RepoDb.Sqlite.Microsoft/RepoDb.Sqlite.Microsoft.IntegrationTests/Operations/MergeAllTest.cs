    ...
    public class MergeAllTest
    {
        ...
        public async Task TestSqLiteConnectionMergeAllAsyncForIdentityForEmptyTable()
        {
            using (var connection = new SqliteConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MergeAllAsync<MdsCompleteTable>(tables).ConfigureAwait(false);
        ...
        public async Task TestSqLiteConnectionMergeAllAsyncForNonIdentityForEmptyTable()
        {
            using (var connection = new SqliteConnection(Database.ConnectionString))
            {
                ...
                // Act
                var result = await connection.MergeAllAsync<MdsNonIdentityCompleteTable>(tables).ConfigureAwait(false);
