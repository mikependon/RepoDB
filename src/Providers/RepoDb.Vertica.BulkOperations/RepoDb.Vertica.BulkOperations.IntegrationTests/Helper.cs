...
namespace RepoDb.Vertica.BulkOperations.IntegrationTests
{
    /// <summary>
    ...
    public static class Helper
    {
        static Helper()
        {
            StatementBuilder = StatementBuilderMapper.Get<VerticaConnection>();
        ...
        /// <summary>
        /// Returns the current UTC time truncated to Vertica's fixed <c>TIMESTAMP</c> precision (4
        /// fractional digits / 100-microsecond resolution). Without truncating here, the sub-100-microsecond
        /// remainder would be silently dropped by Vertica on write, and a direct equality assertion between
        /// the in-memory value and the value read back from the database would fail.
        /// </summary>
        private static DateTime UtcNowVerticaPrecision() =>
            ...
            bool hasId = false)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                tables.Add(new BulkOperationIdentityTable
                {
                    ...
                    ColumnDateTime2 = UtcNowVerticaPrecision(),
        ...
        public static void UpdateBulkOperationIdentityTables(List<BulkOperationIdentityTable> tables)
        {
            ...
            foreach (var table in tables)
            {
                ...
                table.ColumnDateTime2 = UtcNowVerticaPrecision();
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                item["ColumnDateTime2"] = UtcNowVerticaPrecision();
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                tables.Add(new BulkOperationMappedNonIdentityTable
                {
                    ...
                    ColumnDateTime2Mapped = UtcNowVerticaPrecision(),
        ...
        public static void UpdateBulkOperationMappedNonIdentityTables(List<BulkOperationMappedNonIdentityTable> tables)
        {
            ...
            foreach (var table in tables)
            {
                ...
                table.ColumnDateTime2Mapped = UtcNowVerticaPrecision();
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                tables.Add(new
                {
                    ...
                    UnmatchedColumnDateTime2 = UtcNowVerticaPrecision(),
            ...
            bool hasId = true)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                item["UnmatchedColumnDateTime2"] = UtcNowVerticaPrecision();
