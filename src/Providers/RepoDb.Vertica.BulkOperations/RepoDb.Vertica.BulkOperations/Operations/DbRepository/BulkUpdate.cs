...
{
    /// <summary>
    /// <see cref="DbRepository{TDbConnection}"/> wrappers for the Vertica bulk-update operation. See the
    ...
    public static partial class DbRepositoryExtension
    {
        ...
        public static int BulkUpdate<TEntity>(this DbRepository<VerticaConnection> repository,
        ...
        /// <returns>The number of updated rows.</returns>
        public static async Task<int> BulkUpdateAsync<TEntity>(this DbRepository<VerticaConnection> repository,
            IEnumerable<TEntity> entities,
            Expression<Func<TEntity, object>> qualifiers = null,
            IEnumerable<VerticaBulkInsertMapItem> mappings = null,
            int? bulkCopyTimeout = null,
