<div align="center">
    ...
    <br/>
    <span style="font-size:28px;font-weight:bold;"><a href="https://repodb.net/tutorial/get-started-vertica/"><strong>RepoDb.Vertica</strong></a></span>
    <br/>
    <span style="font-size:16px;">A high-performance data productivity platform for Vertica in .NET.</span>
</div>
