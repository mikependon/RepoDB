...
using RepoDb.Benchmarks.EnterpriseDb.EFCore.Models;
using RepoDb.Benchmarks.EnterpriseDb.Setup;

namespace RepoDb.Benchmarks.EnterpriseDb.EFCore
{
    [Description("EFCore")]
    public class EFCoreBaseBenchmarks : EnterpriseDbBenchmark
    {
        [GlobalSetup]
