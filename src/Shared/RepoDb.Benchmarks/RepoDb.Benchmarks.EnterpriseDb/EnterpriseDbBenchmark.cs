...
namespace RepoDb.Benchmarks.EnterpriseDb
{
    public abstract class EnterpriseDbBenchmark : BaseBenchmark
    {
        [GlobalCleanup]
        ...
        protected override IDbConnection GetConnection() => new EDBConnection(DatabaseHelper.ConnectionString);
    }
}
