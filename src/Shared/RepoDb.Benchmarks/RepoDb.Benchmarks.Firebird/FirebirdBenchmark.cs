...
namespace RepoDb.Benchmarks.Firebird
{
    public abstract class FirebirdBenchmark : BaseBenchmark
    {
        [GlobalCleanup]
        ...
        protected override IDbConnection GetConnection() => new FbConnection(DatabaseHelper.ConnectionString);
    }
}
