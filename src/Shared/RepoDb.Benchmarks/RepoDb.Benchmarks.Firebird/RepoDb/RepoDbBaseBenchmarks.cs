...
using RepoDb.Benchmarks.Firebird.Models;

namespace RepoDb.Benchmarks.Firebird.RepoDb
{
    [Description("RepoDB")]
    public class RepoDbBaseBenchmarks : FirebirdBenchmark
    {
        [GlobalSetup]
        public void Setup()
        {
            GlobalConfiguration.Setup().UseFirebird();
