...
{
    [Description("Linq2db")]
    public class Linq2dbBaseBenchmarks : MariaDbConnectorBenchmark
    {
        [GlobalSetup]
        ...
        protected static RepoDbDB GetDb()
        {
            ...
            options = options.UseMySql(DatabaseHelper.ConnectionString, MySqlVersion.MariaDB10, MySqlProvider.MySqlConnector);
