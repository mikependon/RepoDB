...
namespace RepoDb.Benchmarks.MariaDbConnector
{
    public abstract class MariaDbConnectorBenchmark : BaseBenchmark
    {
        [GlobalCleanup]
        ...
        protected override IDbConnection GetConnection() => new MariaDbConnection(DatabaseHelper.ConnectionString);
    }
}
