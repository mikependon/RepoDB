...
{
    [Description("Linq2db")]
    public class Linq2dbBaseBenchmarks : MySqlBenchmark
    {
        [GlobalSetup]
        ...
        protected static RepoDbDB GetDb()
        {
            ...
            options = options.UseMySql(DatabaseHelper.ConnectionString, MySqlVersion.AutoDetect, MySqlProvider.MySqlData);
