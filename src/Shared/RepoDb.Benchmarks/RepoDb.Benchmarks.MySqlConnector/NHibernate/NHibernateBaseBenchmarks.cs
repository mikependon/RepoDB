...
using RepoDb.Benchmarks.MySqlConnector.NHibernate.Models;
using RepoDb.Benchmarks.MySqlConnector.Setup;

namespace RepoDb.Benchmarks.MySqlConnector.NHibernate
{
    [Description("NHibernate")]
    public class NHibernateBaseBenchmarks : MySqlConnectorBenchmark
    {
        ...
        public void Setup()
        {
            ...
            configuration.DataBaseIntegration(properties =>
            {
                ...
                properties.Driver<MySqlConnectorDriver>();
