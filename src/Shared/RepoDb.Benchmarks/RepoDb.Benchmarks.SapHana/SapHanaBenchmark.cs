...
namespace RepoDb.Benchmarks.SapHana
{
    public abstract class SapHanaBenchmark : BaseBenchmark
    {
        [GlobalCleanup]
        ...
        protected override IDbConnection GetConnection() => new HanaConnection(DatabaseHelper.ConnectionString);
    }
}
